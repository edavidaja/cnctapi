...
class GroupOwnershipPermission(object):
    ...
    def __init__(self, principal_guid=None, principal_name=None, principal_role=None, principal_type=None):  # noqa: E501
        """GroupOwnershipPermission - a model defined in Swagger"""  # noqa: E501
        self._principal_guid = None
        self._principal_name = None
        self._principal_role = None
        self._principal_type = None
        self.discriminator = None
        if principal_guid is not None:
    ...
    @property
    def principal_guid(self):
        """Gets the principal_guid of this GroupOwnershipPermission.  # noqa: E501

        The identifier of the principal (user or group) with access to the content.  # noqa: E501

        :return: The principal_guid of this GroupOwnershipPermission.  # noqa: E501
        :rtype: str
        """
        return self._principal_guid

    @principal_guid.setter
    def principal_guid(self, principal_guid):
        """Sets the principal_guid of this GroupOwnershipPermission.

        The identifier of the principal (user or group) with access to the content.  # noqa: E501

        :param principal_guid: The principal_guid of this GroupOwnershipPermission.  # noqa: E501
        :type: str
        """

        self._principal_guid = principal_guid

    @property
    def principal_name(self):
        """Gets the principal_name of this GroupOwnershipPermission.  # noqa: E501

        The name of the principal (user or group) with access to the content.  # noqa: E501

        :return: The principal_name of this GroupOwnershipPermission.  # noqa: E501
        :rtype: str
        """
    ...
    def principal_name(self, principal_name):
        """Sets the principal_name of this GroupOwnershipPermission.

        The name of the principal (user or group) with access to the content.  # noqa: E501

        :param principal_name: The principal_name of this GroupOwnershipPermission.  # noqa: E501
        :type: str
        """
    ...
    def principal_role(self):
        """Gets the principal_role of this GroupOwnershipPermission.  # noqa: E501

        The role of the principal (user or group) with access to the content.  # noqa: E501

        :return: The principal_role of this GroupOwnershipPermission.  # noqa: E501
        :rtype: str
        """
    ...
    def principal_role(self, principal_role):
        """Sets the principal_role of this GroupOwnershipPermission.

        The role of the principal (user or group) with access to the content.  # noqa: E501

        :param principal_role: The principal_role of this GroupOwnershipPermission.  # noqa: E501
        :type: str
        """
        allowed_values = ["author", "viewer", "publisher"]  # noqa: E501
        if principal_role not in allowed_values:
            raise ValueError(
                "Invalid value for `principal_role` ({0}), must be one of {1}"  # noqa: E501
                .format(principal_role, allowed_values)
            )
    ...
    def principal_type(self):
        """Gets the principal_type of this GroupOwnershipPermission.  # noqa: E501

        The type of the principal (user or group) with access to the content.  # noqa: E501

        :return: The principal_type of this GroupOwnershipPermission.  # noqa: E501
        :rtype: str
        """
    ...
    def principal_type(self, principal_type):
        """Sets the principal_type of this GroupOwnershipPermission.

        The type of the principal (user or group) with access to the content.  # noqa: E501

        :param principal_type: The principal_type of this GroupOwnershipPermission.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupOwnershipPermission, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupOwnershipPermission):
            return False
