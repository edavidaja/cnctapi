...
class ContentV1ExperimentalApi(object):
    ...
    def create_content(self, body, **kwargs):  # noqa: E501
        ...
        :param ExperimentalContentBody body: The request body required when creating a new content item. (required)
        :return: ContentV1Exp
    ...
    def create_content_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ContentV1Exp',  # noqa: E501
    ...
    def delete_content_with_http_info(self, guid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/experimental/content/{guid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def deploy_content_bundle(self, guid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str guid: The unique identifier of the desired content item. (required)
        :param GuidDeployBody1 body: The request body when requesting the deployment of a bundle.
    ...
    def deploy_content_bundle_with_http_info(self, guid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/experimental/content/{guid}/deploy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_content_with_http_info(self, guid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/experimental/content/{guid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_content(self, body, guid, **kwargs):  # noqa: E501
        ...
        Update fields for a specific content item.  Authenticated access from a user having either \"publisher\" or \"administrator\" role is allowed. All other clients are rejected.  Authorized clients with collaborator or administrator rights are permitted to modify content item fields.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param ContentGuidBody1 body: The request body required when creating a new content item. (required)
        :param str guid: The unique identifier of the desired content item. (required)
        :return: ContentV1Exp
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_content_with_http_info(self, body, guid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/experimental/content/{guid}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def upload_content_bundle(self, body, guid, **kwargs):  # noqa: E501
        """Upload deployment bundle  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_content_bundle(body, guid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Object body: A `gzip` compressed `tar` archive file. (required)
        :param str guid: The unique identifier of the desired content item. (required)
        :param str x_content_checksum: The Base64-encoded MD5 sum of the archive file.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upload_content_bundle_with_http_info(body, guid, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_content_bundle_with_http_info(body, guid, **kwargs)  # noqa: E501
            return data

    def upload_content_bundle_with_http_info(self, body, guid, **kwargs):  # noqa: E501
        """Upload deployment bundle  # noqa: E501

        Upload a new deployment bundle.  Upload a compressed `tar` archive containing code/data that represent one deployment of this content. Bundles must be `gzip` compressed `tar` archives.  All deployment bundles include a `manifest.json` describing the contained files and their runtime dependencies.  A bundle for a Shiny application include an `app.R` or `ui.R` and `server.R`, and any images or data files required by the application.  An R Markdown document bundle includes the `index.Rmd` file along with any R scripts and data files needed to render the report.  Bundles containing HTML content would include the CSS, Javascript, and images required by that document.  The archive paths for the `manifest.json` file and primary source files like `app.R` or `index.Rmd` must not specify a directory structure. Directories may be used for secondary data and scripts.  Here is how you might use `tar` to create an archive for a Shiny application. It includes the manifest, the application, and an image.  ```bash tar zcf bundle.tar.gz ./manifest.json ./app.R ./www/logo.png ```  Here is another example of creating a bundle for that same application but from its parent directory. The Shiny application is in a `sales-analyzer` sub-directory.  ```bash tar -C sales-analyzer zcf bundle.tar.gz . ```  Both `tar` commands will produce an archive with the `manifest.json` and `app.R` at the top-most level.  Publishers with collaborator rights to this content (including the owner) are permitted to upload deployment bundles. Users without these rights are rejected.  Administrators must be a collaborator for a content item before they receive upload rights.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_content_bundle_with_http_info(body, guid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'guid', 'x_content_checksum']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_content_bundle" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `upload_content_bundle`")  # noqa: E501
        # verify the required parameter 'guid' is set
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `upload_content_bundle`")  # noqa: E501
        ...
        header_params = {}
        if 'x_content_checksum' in params:
            header_params['X-Content-Checksum'] = params['x_content_checksum']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/experimental/content/{guid}/upload', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
