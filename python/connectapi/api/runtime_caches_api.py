...
class RuntimeCachesApi(object):
    ...
    def delete_runtime_cache(self, body, **kwargs):  # noqa: E501
        """Delete a runtime cache  # noqa: E501

        Delete a content runtime package cache by specifying language, version, and execution environment. This action is only available to administrators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_runtime_cache(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CachesRuntimeBody body: The target runtime cache. (required)
        ...
        if kwargs.get('async_req'):
            return self.delete_runtime_cache_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_runtime_cache_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def delete_runtime_cache_with_http_info(self, body, **kwargs):  # noqa: E501
        """Delete a runtime cache  # noqa: E501

        Delete a content runtime package cache by specifying language, version, and execution environment. This action is only available to administrators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_runtime_cache_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_runtime_cache" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `delete_runtime_cache`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/system/caches/runtime', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='DeleteRuntimeCacheResponse',  # noqa: E501
    ...
    def list_runtime_caches(self, **kwargs):  # noqa: E501
        """List runtime caches  # noqa: E501

        List all content runtime caches. These include packrat and Python environment caches. This information is available only to administrators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_runtime_caches(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_runtime_caches_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_runtime_caches_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_runtime_caches_with_http_info(self, **kwargs):  # noqa: E501
        """List runtime caches  # noqa: E501

        List all content runtime caches. These include packrat and Python environment caches. This information is available only to administrators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_runtime_caches_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_runtime_caches" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RuntimeCaches',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
