...
class GroupsApi(object):
    ...
    def add_group_member(self, body, group_guid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.add_group_member_with_http_info(body, group_guid, **kwargs)  # noqa: E501
        else:
            (data) = self.add_group_member_with_http_info(body, group_guid, **kwargs)  # noqa: E501
            return data

    def add_group_member_with_http_info(self, body, group_guid, **kwargs):  # noqa: E501
        """Add a group member  # noqa: E501

        This endpoint adds a user to a group.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. If the auth provider   is configured to provide group membership information,   then it is not possible to add/remove members via this API. - Administrator access is required to modify a group you do   not own.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_group_member_with_http_info(body, group_guid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'group_guid']  # noqa: E501
        ...
        if ('group_guid' not in params or
                params['group_guid'] is None):
            raise ValueError("Missing the required parameter `group_guid` when calling `add_group_member`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'group_guid' in params:
            path_params['group_guid'] = params['group_guid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/groups/{group_guid}/members', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_group(self, body, **kwargs):  # noqa: E501
        """Create a group from caller-supplied details (Password, PAM, OAuth2, SAML, Proxied)   # noqa: E501

        This endpoint creates the given group.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. - Publisher or administrator access is required to create   groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param V1GroupsBody1 body: The new group values. (required)
        :return: Group
                 If the method is called asynchronously,
                 returns the request thread.
        """
...
server. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_remote_group_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_remote_group_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_remote_group_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a group using details from a remote authentication provider (LDAP)   # noqa: E501

        This endpoint creates the given group on the Posit Connect server.  - This endpoint is used only for LDAP authentication. Password,   PAM, SAML, OAuth2 and Proxied authentication providers should   use the    <a href=\"#post-/v1/groups\">POST /v1/groups</a>   endpoint. - Publisher or administrator access is required to access this   endpoint. - Group members will be automatically populated from the LDAP server.  #### Group Creation Workflow on LDAP  The API lets you identify an existing group in the LDAP system and create a corresponding group on Posit Connect. This is a two-step process:  - Use the    <a href=\"#get-/v1/groups/remote\">GET /v1/groups/remote</a>   endpoint. This endpoint will return a list of potential   matching groups in LDAP. A group that does not exist in   Posit Connect will lack a `guid`. Note the `temp_ticket`   for the desired group. - Use this PUT endpoint with the `temp_ticket` to create a   corresponding group on Posit Connect.  The [Create a Group from LDAP](../cookbook/groups/#create-group-ldap) recipe in the API Cookbook has sample code using this workflow.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_remote_group_with_http_info(body, async_req=True)
        >>> result = thread.get()
...
server. (required)
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_remote_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_remote_group`")  # noqa: E501
    ...
    def delete_group(self, guid, **kwargs):  # noqa: E501
        """Delete a group  # noqa: E501

        Delete the given group.  - This endpoint can be used only when groups are enabled in   Posit Connnect and will return an error otherwise. - Administrator access is required to delete a group you do   not own.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_group(guid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str guid: The group's unique identifier (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_group_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_group_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def delete_group_with_http_info(self, guid, **kwargs):  # noqa: E501
        """Delete a group  # noqa: E501

        Delete the given group.  - This endpoint can be used only when groups are enabled in   Posit Connnect and will return an error otherwise. - Administrator access is required to delete a group you do   not own.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_group_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `delete_group`")  # noqa: E501
    ...
    def get_group(self, guid, **kwargs):  # noqa: E501
        """Get group details  # noqa: E501

        Get detailed information on a specific group.  This endpoint is available only when groups are enabled in Posit Connect.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_group(guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_group_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_group_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def get_group_with_http_info(self, guid, **kwargs):  # noqa: E501
        """Get group details  # noqa: E501

        Get detailed information on a specific group.  This endpoint is available only when groups are enabled in Posit Connect.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_group_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `get_group`")  # noqa: E501
    ...
    def get_group_members(self, group_guid, **kwargs):  # noqa: E501
        """Get group member details  # noqa: E501

        This endpoint gets the group member details. Group member enumeration is currently not supported for LDAP.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. - The `email` field is not populated for non-admins when   `Server.HideEmailAddresses` is enabled.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_group_members(group_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_group_members_with_http_info(group_guid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_group_members_with_http_info(group_guid, **kwargs)  # noqa: E501
            return data

    def get_group_members_with_http_info(self, group_guid, **kwargs):  # noqa: E501
        """Get group member details  # noqa: E501

        This endpoint gets the group member details. Group member enumeration is currently not supported for LDAP.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. - The `email` field is not populated for non-admins when   `Server.HideEmailAddresses` is enabled.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_group_members_with_http_info(group_guid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['group_guid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('group_guid' not in params or
                params['group_guid'] is None):
            raise ValueError("Missing the required parameter `group_guid` when calling `get_group_members`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/groups/{group_guid}/members', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_group_ownership(self, guid, **kwargs):  # noqa: E501
        """List content for which a group with given GUID has access to  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_group_ownership(guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_group_ownership_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_group_ownership_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def get_group_ownership_with_http_info(self, guid, **kwargs):  # noqa: E501
        """List content for which a group with given GUID has access to  # noqa: E501

        This endpoint takes a group GUID and returns a list of content items with access control lists that the given group is listed on. This includes content accessible only by specific users or groups that include the given group, as well as content accessible by anyone or only logged-in users that includes the given group as a collaborator.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_group_ownership_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_group_ownership" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'guid' is set
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `get_group_ownership`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/experimental/groups/{guid}/content', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GroupOwnership',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_groups(self, **kwargs):  # noqa: E501
        """List or search for group details  # noqa: E501

        This endpoint lists or searches for local groups.  - For a `prefix` search, results are sorted based on   similarity to the `prefix`. A `prefix` search ignores   `asc_order`. The first page of results will always be   returned. - The `prefix` can also be an exact match for the   group's DN (for LDAP) or the auth provider's unique ID   for the group, if any. - For a non-`prefix` search, results are sorted by group name.  This endpoint is available only when groups are enabled in Posit Connect and it will return an error otherwise.  #### Pagination  This endpoint uses offset pagination (using page numbers). The [Offset Pagination](../cookbook/pagination/#offset-pagination) recipe in the Posit Connect API Cookbook has sample code for fetching multiple pages from a list endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str prefix: Filters groups by prefix (group name). The filter is case insensitive.
        :param int page_number: The page to return relative to the given `page_size`. If `page_number` is 0 or negative, an error will be returned. For a `prefix` search, the first page of results will always be returned.
        :param int page_size: The number of items to include in each page. This parameter is \"best effort\" since there may not be enough groups to honor the request. If `page_size` is less than 1 or greater than 500, an error will be returned.
        :param bool asc_order: Whether or not to return the groups in ascending order, sorted by name. For a `prefix` search, results are sorted first by exact match, then by increasing word length.
        :return: Groups
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_groups_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['prefix', 'page_number', 'page_size', 'asc_order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def remove_group_member(self, group_guid, user_guid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_group_member_with_http_info(group_guid, user_guid, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_group_member_with_http_info(group_guid, user_guid, **kwargs)  # noqa: E501
            return data

    def remove_group_member_with_http_info(self, group_guid, user_guid, **kwargs):  # noqa: E501
        """Remove a group member  # noqa: E501

        This endpoint removes a user from a group.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. If the auth provider   is configured to provide group membership information,   then it is not possible to add/remove members via this API. - Administrator access is required to remove a user from a   group you do not own, but no special access is needed to   remove yourself from a group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_group_member_with_http_info(group_guid, user_guid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['group_guid', 'user_guid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('group_guid' not in params or
                params['group_guid'] is None):
            raise ValueError("Missing the required parameter `group_guid` when calling `remove_group_member`")  # noqa: E501
        # verify the required parameter 'user_guid' is set
        if ('user_guid' not in params or
                params['user_guid'] is None):
            raise ValueError("Missing the required parameter `user_guid` when calling `remove_group_member`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/groups/{group_guid}/members/{user_guid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_remote_groups(self, prefix, **kwargs):  # noqa: E501
        """Search for group details from a remote provider  # noqa: E501

        This endpoint is used to support operations against groups not managed by Connect, such as  <a href=\"#post-/v1/groups\">creating LDAP groups</a> See <a href=\"#get-/v1/groups\">GET /v1/groups</a> for listing groups on Posit Connect.  This endpoint searches for groups on Posit Connect and on your LDAP system.  Results are sorted based on similarity to the `prefix`.  - This endpoint can be used only by LDAP authentication and   will return an error otherwise. - Publisher or administrator access is required to access this   endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_remote_groups(prefix, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str prefix: Search groups by prefix. `prefix` is case insensitive. (required)
        :param int limit: The maximum number of groups to include in the results. If `limit` is less than 1 or greater than 500, an error will be returned.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_remote_groups_with_http_info(prefix, **kwargs)  # noqa: E501
        else:
            (data) = self.search_remote_groups_with_http_info(prefix, **kwargs)  # noqa: E501
            return data

    def search_remote_groups_with_http_info(self, prefix, **kwargs):  # noqa: E501
        """Search for group details from a remote provider  # noqa: E501

        This endpoint is used to support operations against groups not managed by Connect, such as  <a href=\"#post-/v1/groups\">creating LDAP groups</a> See <a href=\"#get-/v1/groups\">GET /v1/groups</a> for listing groups on Posit Connect.  This endpoint searches for groups on Posit Connect and on your LDAP system.  Results are sorted based on similarity to the `prefix`.  - This endpoint can be used only by LDAP authentication and   will return an error otherwise. - Publisher or administrator access is required to access this   endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_remote_groups_with_http_info(prefix, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_remote_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('prefix' not in params or
            ...
            raise ValueError("Missing the required parameter `prefix` when calling `search_remote_groups`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GroupRemoteSearch',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_group(self, body, guid, **kwargs):  # noqa: E501
        """Modify a group name or owner (Password, PAM, OAuth2, SAML, Proxied)   # noqa: E501

        This endpoint modifies the given group.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. - Publisher or administrator access is required to modify   groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_group(body, guid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GroupsGuidBody body: The new group name and/or owner. (required)
        :param str guid: The group's unique identifier (required)
        :return: Group
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_group_with_http_info(body, guid, **kwargs)  # noqa: E501
        else:
            (data) = self.update_group_with_http_info(body, guid, **kwargs)  # noqa: E501
            return data

    def update_group_with_http_info(self, body, guid, **kwargs):  # noqa: E501
        """Modify a group name or owner (Password, PAM, OAuth2, SAML, Proxied)   # noqa: E501

        This endpoint modifies the given group.  - This endpoint is available only when groups are enabled   in Posit Connect and only for Password, PAM, OAuth2,   SAML and Proxied authentication. - Publisher or administrator access is required to modify   groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_group_with_http_info(body, guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `update_group`")  # noqa: E501
