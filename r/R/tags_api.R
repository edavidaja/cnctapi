...
#' @section Methods:
#' \describe{
#' \strong{ AddTag } \emph{ Add tag to content }
...
#' \item \emph{ @param } tag \link{AddTagRequest}
#' \item \emph{ @returnType } list( \link{Tag} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Empty content on success
#'
#' \item return type : array[Tag]
...
#' }
#'
#' \strong{ CreateTag } \emph{ Create tag }
...
#'
#' \itemize{
#' \item \emph{ @param } tag \link{CreateTagRequest}
#' \item \emph{ @returnType } \link{Tag} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The newly created tag
#'
...
#' }
#'
#' \strong{ DeleteTag } \emph{ Delete tag }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 204 | No content on success
#'
#'
#' \item response headers :
#'
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested tag
#'
#' \item return type : Tag
#' \item response headers :
#'
...
#' }
#'
#' \strong{ GetTagByPath } \emph{ Get tag by path }
...
#' }
#'
#' \strong{ ListContentTags } \emph{ List tags for content }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of tags
#'
#' \item return type : array[Tag]
#' \item response headers :
#'
...
#' }
#'
#' \strong{ ListTagContent } \emph{ List content for tags }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of content
#'
...
#' }
#'
#' \strong{ ListTags } \emph{ List tags }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of all tags
#'
#' \item return type : array[Tag]
#' \item response headers :
#'
...
#' }
#'
#' \strong{ RemoveTag } \emph{ Remove tag from content }
...
#' }
#'
#' \strong{ UpdateTag } \emph{ Update tag }
#' Update an existing tag.  Authenticated access from a user having an \"administrator\" role is required.
#'
#' \itemize{
#' \item \emph{ @param } id character
#' \item \emph{ @param } tag \link{UpdateTagRequest}
#' \item \emph{ @returnType } \link{Tag} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The updated tag
#'
#' \item return type : Tag
#' \item response headers :
#'
...
TagsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' Add tag to content
    #'
    #' @param guid The unique identifier of the content item.
    #' @param tag The request body specifies which tag to add
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return array[Tag]
    #' @export
    AddTag = function(guid, tag, data_file = NULL, ...) {
      local_var_response <- self$AddTagWithHttpInfo(guid, tag, data_file = data_file, ...)
    ...
    #' @export
    AddTagWithHttpInfo = function(guid, tag, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`tag`)) {
        rlang::abort(message = "Missing required parameter `tag`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Missing required parameter `tag`."))
      }
      ...
      local_var_url_path <- "/v1/content/{guid}/tags"
      if (!missing(`guid`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[Tag]", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' Create tag
    #'
    #' @param tag The request body required when creating a new tag.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Tag
    #' @export
    CreateTag = function(tag, data_file = NULL, ...) {
      local_var_response <- self$CreateTagWithHttpInfo(tag, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (Tag) with additional information such as HTTP status code, headers
    #' @export
    CreateTagWithHttpInfo = function(tag, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "Tag", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    DeleteTag = function(id, ...) {
      local_var_response <- self$DeleteTagWithHttpInfo(id, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    DeleteTagWithHttpInfo = function(id, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @return Tag
    #' @export
    GetTag = function(id, data_file = NULL, ...) {
      local_var_response <- self$GetTagWithHttpInfo(id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Tag) with additional information such as HTTP status code, headers
    #' @export
    GetTagWithHttpInfo = function(id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' Get tag by path
    #'
    #' @param path The path to the tag, as comma-delimited names
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Tag
    #' @export
    GetTagByPath = function(path, data_file = NULL, ...) {
      local_var_response <- self$GetTagByPathWithHttpInfo(path, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Tag) with additional information such as HTTP status code, headers
    #' @export
    GetTagByPathWithHttpInfo = function(path, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`path`)) {
        rlang::abort(message = "Missing required parameter `path`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
      ...
      local_var_url_path <- "/v1/tags/{path}"
      if (!missing(`path`)) {
    ...
    #' @return array[Tag]
    #' @export
    ListContentTags = function(guid, data_file = NULL, ...) {
      local_var_response <- self$ListContentTagsWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (array[Tag]) with additional information such as HTTP status code, headers
    #' @export
    ListContentTagsWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @export
    ListTagContent = function(id, data_file = NULL, ...) {
      local_var_response <- self$ListTagContentWithHttpInfo(id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    ListTagContentWithHttpInfo = function(id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/tags/{id}/content"
      if (!missing(`id`)) {
        local_var_url_path <- gsub("\\{id\\}", URLencode(as.character(`id`), reserved = TRUE), local_var_url_path)
      }
    ...
    #' List tags
    #'
    #' @param parent_id (optional) The unique identifier of the parent tag
    #' @param name (optional) The tag name  Note: tag names are only unique within the scope of a parent, which means that it is possible to have multiple results when querying by name; however, querying by both `name` and `parent_id` ensures a single result.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return array[Tag]
    #' @export
    ListTags = function(parent_id = NULL, name = NULL, data_file = NULL, ...) {
      local_var_response <- self$ListTagsWithHttpInfo(parent_id, name, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (array[Tag]) with additional information such as HTTP status code, headers
    #' @export
    ListTagsWithHttpInfo = function(parent_id = NULL, name = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @return array[Tag]
    #' @export
    RemoveTag = function(guid, id, data_file = NULL, ...) {
      local_var_response <- self$RemoveTagWithHttpInfo(guid, id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (array[Tag]) with additional information such as HTTP status code, headers
    #' @export
    RemoveTagWithHttpInfo = function(guid, id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/tags/{id}"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
    ...
    #'
    #' @param id The unique identifier of the tag.
    #' @param tag The request body required when updating an existing tag.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Tag
    #' @export
    UpdateTag = function(id, tag, data_file = NULL, ...) {
      local_var_response <- self$UpdateTagWithHttpInfo(id, tag, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Tag) with additional information such as HTTP status code, headers
    #' @export
    UpdateTagWithHttpInfo = function(id, tag, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
