...
#'
#' @docType class
#' @title BundlesV1Experimental operations
#' @description BundlesV1ExperimentalApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ DeleteBundle } \emph{ Delete bundle }
...
#'
#' \item status code : 204 | Returned when the bundle was successfully removed.
#'
#'
...
#' }
#'
#' \strong{ DownloadBundle } \emph{ Download the bundle archive }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | A `gzip` compressed `tar` archive file.
#'
...
#' }
#'
#' \strong{ GetBundle } \emph{ Get bundle details }
...
#' \itemize{
#' \item \emph{ @param } id character
#' \item \emph{ @returnType } \link{BundleV1Exp} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The bundle details.
#'
#' \item return type : BundleV1Exp
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ GetBundles } \emph{ List bundles }
...
#' \item \emph{ @returnType } \link{BundlesV1Exp} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of bundles.
#'
#' \item return type : BundlesV1Exp
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' @export
BundlesV1ExperimentalApi <- R6::R6Class(
  "BundlesV1ExperimentalApi",
  public = list(
    api_client = NULL,
    #' Initialize a new BundlesV1ExperimentalApi.
    #'
    #' @description
    #' Initialize a new BundlesV1ExperimentalApi.
    #'
    ...
    DeleteBundle = function(id, ...) {
      local_var_response <- self$DeleteBundleWithHttpInfo(id, ...)
    ...
    #' @export
    DeleteBundleWithHttpInfo = function(id, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/experimental/bundles/{id}"
      if (!missing(`id`)) {
    ...
    #' @return data.frame
    #' @export
    DownloadBundle = function(id, data_file = NULL, ...) {
      local_var_response <- self$DownloadBundleWithHttpInfo(id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    DownloadBundleWithHttpInfo = function(id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/experimental/bundles/{id}/download"
      if (!missing(`id`)) {
        local_var_url_path <- gsub("\\{id\\}", URLencode(as.character(`id`), reserved = TRUE), local_var_url_path)
      }
    ...
    #' @return BundleV1Exp
    #' @export
    GetBundle = function(id, data_file = NULL, ...) {
      local_var_response <- self$GetBundleWithHttpInfo(id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (BundleV1Exp) with additional information such as HTTP status code, headers
    #' @export
    GetBundleWithHttpInfo = function(id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "BundleV1Exp", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @param page_size (optional) The number of items to include in each page. This parameter is \"best effort\" since there may not be enough bundles to honor the request. If `page_size` is less than 1 or greater than 500, an error will be returned. (default value: 20)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return BundlesV1Exp
    #' @export
    GetBundles = function(guid, page_number = 1, page_size = 20, data_file = NULL, ...) {
      local_var_response <- self$GetBundlesWithHttpInfo(guid, page_number, page_size, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (BundlesV1Exp) with additional information such as HTTP status code, headers
    #' @export
    GetBundlesWithHttpInfo = function(guid, page_number = 1, page_size = 20, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (`page_number` < 1) {
        rlang::abort(message = "Invalid value for `page_number` when calling BundlesV1ExperimentalApi$GetBundles, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `page_number` when calling BundlesV1ExperimentalApi$GetBundles, must be bigger than or equal to 1."))
      }

      if (`page_size` > 500) {
        rlang::abort(message = "Invalid value for `page_size` when calling BundlesV1ExperimentalApi$GetBundles, must be smaller than or equal to 500.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `page_size` when calling BundlesV1ExperimentalApi$GetBundles, must be smaller than or equal to 500."))
      }
      if (`page_size` < 1) {
        rlang::abort(message = "Invalid value for `page_size` when calling BundlesV1ExperimentalApi$GetBundles, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `page_size` when calling BundlesV1ExperimentalApi$GetBundles, must be bigger than or equal to 1."))
      }
      ...
      local_var_url_path <- "/v1/experimental/content/{guid}/bundles"
      if (!missing(`guid`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "BundlesV1Exp", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
