...
class ContentGuidBody1(object):
    ...
    def __init__(self, name='', title='null', description='', access_type='acl', connection_timeout=None, read_timeout=None, init_timeout=None, idle_timeout=None, max_processes=None, min_processes=None, max_conns_per_process=None, load_factor=None):  # noqa: E501
        """ContentGuidBody1 - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._title = None
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ContentGuidBody1.

        A simple, URL-friendly identifier. Allows alpha-numeric characters, hyphens (`\"-\"`), and underscores (`\"_\"`).  # noqa: E501

        :param name: The name of this ContentGuidBody1.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def title(self):
        """Gets the title of this ContentGuidBody1.  # noqa: E501

        The title of this content.  # noqa: E501

        :return: The title of this ContentGuidBody1.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ContentGuidBody1.

        The title of this content.  # noqa: E501

        :param title: The title of this ContentGuidBody1.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ContentGuidBody1.  # noqa: E501

        A rich description of this content.  # noqa: E501

        :return: The description of this ContentGuidBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ContentGuidBody1.

        A rich description of this content.  # noqa: E501

        :param description: The description of this ContentGuidBody1.  # noqa: E501
        :type: str
        """
    ...
    def access_type(self):
        """Gets the access_type of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The access_type of this ContentGuidBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def access_type(self, access_type):
        """Sets the access_type of this ContentGuidBody1.

        Access type describes how this content manages its viewers. The value `all` is the most permissive; any visitor to Posit Connect will be able to view this content. The value `logged_in` indicates that all Posit Connect accounts may view the content. The `acl` value lets specifically enumerated users and groups view the content. Users configured as collaborators may always view content.  # noqa: E501

        :param access_type: The access_type of this ContentGuidBody1.  # noqa: E501
        :type: str
        """
    ...
    def connection_timeout(self):
        """Gets the connection_timeout of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The connection_timeout of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def connection_timeout(self, connection_timeout):
        """Sets the connection_timeout of this ContentGuidBody1.

        Maximum number of seconds allowed without data sent or received across a client connection. A value of `0` means connections will never time-out (not recommended). When `null`, the default `Scheduler.ConnectionTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param connection_timeout: The connection_timeout of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def read_timeout(self):
        """Gets the read_timeout of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The read_timeout of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def read_timeout(self, read_timeout):
        """Sets the read_timeout of this ContentGuidBody1.

        Maximum number of seconds allowed without data received from a client connection. A value of `0` means a lack of client (browser) interaction never causes the connection to close. When `null`, the default `Scheduler.ReadTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param read_timeout: The read_timeout of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def init_timeout(self):
        """Gets the init_timeout of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The init_timeout of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def init_timeout(self, init_timeout):
        """Sets the init_timeout of this ContentGuidBody1.

        The maximum number of seconds allowed for an interactive application to start. Posit Connect must be able to connect to a newly launched Shiny application, for example, before this threshold has elapsed. When `null`, the default `Scheduler.InitTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param init_timeout: The init_timeout of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def idle_timeout(self):
        """Gets the idle_timeout of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The idle_timeout of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def idle_timeout(self, idle_timeout):
        """Sets the idle_timeout of this ContentGuidBody1.

        The maximum number of seconds a worker process for an interactive application to remain alive after it goes idle (no active connections). When `null`, the default `Scheduler.IdleTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param idle_timeout: The idle_timeout of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def max_processes(self):
        """Gets the max_processes of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The max_processes of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def max_processes(self, max_processes):
        """Sets the max_processes of this ContentGuidBody1.

        Specifies the total number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MaxProcesses` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param max_processes: The max_processes of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def min_processes(self):
        """Gets the min_processes of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The min_processes of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def min_processes(self, min_processes):
        """Sets the min_processes of this ContentGuidBody1.

        Specifies the minimum number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MinProcesses` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param min_processes: The min_processes of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def max_conns_per_process(self):
        """Gets the max_conns_per_process of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The max_conns_per_process of this ContentGuidBody1.  # noqa: E501
        :rtype: int
        """
    ...
    def max_conns_per_process(self, max_conns_per_process):
        """Sets the max_conns_per_process of this ContentGuidBody1.

        Specifies the maximum number of client connections allowed to an individual process. Incoming connections which will exceed this limit are routed to a new process or rejected. When `null`, the default `Scheduler.MaxConnsPerProcess` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param max_conns_per_process: The max_conns_per_process of this ContentGuidBody1.  # noqa: E501
        :type: int
        """
    ...
    def load_factor(self):
        """Gets the load_factor of this ContentGuidBody1.  # noqa: E501
        ...
        :return: The load_factor of this ContentGuidBody1.  # noqa: E501
        :rtype: float
        """
    ...
    def load_factor(self, load_factor):
        """Sets the load_factor of this ContentGuidBody1.

        Controls how aggressively new processes are spawned. When `null`, the default `Scheduler.LoadFactor` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param load_factor: The load_factor of this ContentGuidBody1.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContentGuidBody1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentGuidBody1):
            return False
