...
#' @section Methods:
#' \describe{
#' \strong{ BuildContentBundle } \emph{ Build deployment bundle }
...
#' \item \emph{ @param } instructions \link{BuildContentBundleRequest}
#' \item \emph{ @returnType } \link{BuildContentBundle200Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested build task.
#'
#' \item return type : BuildContentBundle200Response
...
#' }
#'
#' \strong{ CreateContent } \emph{ Create content item }
...
#'
#' \itemize{
#' \item \emph{ @param } content \link{CreateContentRequest}
#' \item \emph{ @returnType } \link{Content} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The details for the newly created content.
#'
#' \item return type : Content
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ DeleteContent } \emph{ Delete content }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 204 | Returned when the content was successfully removed.
#'
#'
#' \item response headers :
#'
...
#' }
#'
#' \strong{ DeployContentBundle } \emph{ Deploy deployment bundle }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } instructions \link{DeployContentBundleRequest}
#' \item \emph{ @returnType } \link{DeployContentBundle202Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 202 | The deployment task which can be queried to monitor the deployment status.
#'
#' \item return type : DeployContentBundle202Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ GetContent } \emph{ Get content details }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested content details.
#'
#' \item return type : Content
#' \item response headers :
#'
...
#' }
#'
#' \strong{ GetContentEnvironment } \emph{ Get environment variables }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of environment variable names defined for this content item.
#'
...
#' }
#'
#' \strong{ GetContents } \emph{ List content items }
...
#'
#' \itemize{
#' \item \emph{ @param } owner_guid character
#' \item \emph{ @param } name character
#' \item \emph{ @returnType } list( \link{Content} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | An array of content items
#'
#' \item return type : array[Content]
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ SetContentEnvironment } \emph{ Set all environment variables }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } environment list( \link{EnvironmentVariable} )
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The updated list of environment variable names. Since environment variables may contain sensitive information, the values are not included in the returned data.
#'
#' \item return type : array[character]
#' \item response headers :
#'
...
#' }
#'
#' \strong{ UpdateContent } \emph{ Update content }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } content \link{UpdateContentRequest}
#' \item \emph{ @returnType } \link{Content} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The details for the updated content.
#'
#' \item return type : Content
#' \item response headers :
#'
...
#' }
#'
#' \strong{ UpdateContentEnvironment } \emph{ Update environment variables }
...
ContentApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param instructions (optional) The request body when requesting the building of a specific bundle.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return BuildContentBundle200Response
    #' @export
    BuildContentBundle = function(guid, instructions = NULL, data_file = NULL, ...) {
      local_var_response <- self$BuildContentBundleWithHttpInfo(guid, instructions, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (BuildContentBundle200Response) with additional information such as HTTP status code, headers
    #' @export
    BuildContentBundleWithHttpInfo = function(guid, instructions = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`instructions`)) {
        local_var_body <- `instructions`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/v1/content/{guid}/build"
      if (!missing(`guid`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "BuildContentBundle200Response", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' Create content item
    #'
    #' @param content The request body required when creating a new content item.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Content
    #' @export
    CreateContent = function(content, data_file = NULL, ...) {
      local_var_response <- self$CreateContentWithHttpInfo(content, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (Content) with additional information such as HTTP status code, headers
    #' @export
    CreateContentWithHttpInfo = function(content, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`content`)) {
        rlang::abort(message = "Missing required parameter `content`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
      ...
      if (!is.null(`content`)) {
        local_var_body <- `content`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/v1/content"
      # API key authentication
      if ("Authorization" %in% names(self$api_client$api_keys) && nchar(self$api_client$api_keys["Authorization"]) > 0) {
        header_params["Authorization"] <- paste(unlist(self$api_client$api_keys["Authorization"]), collapse = "")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "Content", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return void
    #' @export
    DeleteContent = function(guid, ...) {
      local_var_response <- self$DeleteContentWithHttpInfo(guid, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    DeleteContentWithHttpInfo = function(guid, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
    ...
    #'
    #' @param guid The unique identifier of the desired content item.
    #' @param instructions (optional) The request body when requesting the deployment of a bundle.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return DeployContentBundle202Response
    #' @export
    DeployContentBundle = function(guid, instructions = NULL, data_file = NULL, ...) {
      local_var_response <- self$DeployContentBundleWithHttpInfo(guid, instructions, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (DeployContentBundle202Response) with additional information such as HTTP status code, headers
    #' @export
    DeployContentBundleWithHttpInfo = function(guid, instructions = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/deploy"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "DeployContentBundle202Response", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return Content
    #' @export
    GetContent = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetContentWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Content) with additional information such as HTTP status code, headers
    #' @export
    GetContentWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @export
    GetContentEnvironment = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetContentEnvironmentWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    GetContentEnvironmentWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/environment"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[character]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' List content items
    #'
    #' @param owner_guid (optional) The unique identifier of the user who owns the content.
    #' @param name (optional) The content name specified when the content was created.  Note: content names are unique within the owning user's account, so a request that specifies a non-empty name and owner_guid will return at most one content item.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return array[Content]
    #' @export
    GetContents = function(owner_guid = NULL, name = NULL, data_file = NULL, ...) {
      local_var_response <- self$GetContentsWithHttpInfo(owner_guid, name, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[Content]) with additional information such as HTTP status code, headers
    #' @export
    GetContentsWithHttpInfo = function(owner_guid = NULL, name = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      query_params[["owner_guid"]] <- `owner_guid`
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[Content]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #'
    #' @param guid The unique identifier of the desired content item.
    #' @param environment The environment definition to apply to this content item.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return array[character]
    #' @export
    SetContentEnvironment = function(guid, environment, data_file = NULL, ...) {
      local_var_response <- self$SetContentEnvironmentWithHttpInfo(guid, environment, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (array[character]) with additional information such as HTTP status code, headers
    #' @export
    SetContentEnvironmentWithHttpInfo = function(guid, environment, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`environment`)) {
        rlang::abort(message = "Missing required parameter `environment`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Missing required parameter `environment`."))
      }



      if (!is.null(`environment`)) {
        body.items <- paste(unlist(lapply(`environment`, function(param) {
                                                             param$toJSONString()
                                                         })), collapse = ",")
    ...
    #' Update content
    #'
    #' @param guid The unique identifier of the content item to update.
    #' @param content The request body required when updating a content item.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Content
    #' @export
    UpdateContent = function(guid, content, data_file = NULL, ...) {
      local_var_response <- self$UpdateContentWithHttpInfo(guid, content, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Content) with additional information such as HTTP status code, headers
    #' @export
    UpdateContentWithHttpInfo = function(guid, content, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @return array[character]
    #' @export
    UpdateContentEnvironment = function(guid, environment, data_file = NULL, ...) {
      local_var_response <- self$UpdateContentEnvironmentWithHttpInfo(guid, environment, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (array[character]) with additional information such as HTTP status code, headers
    #' @export
    UpdateContentEnvironmentWithHttpInfo = function(guid, environment, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
