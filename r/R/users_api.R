...
#' @section Methods:
#' \describe{
#' \strong{ CreatePullUser } \emph{ Create a user using details from a remote authentication provider (LDAP, OAuth2 with Google) }
...
#'
#' \itemize{
#' \item \emph{ @param } request \link{CreatePullUserRequest}
#' \item \emph{ @returnType } \link{User} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The user object
#'
...
#' }
#'
#' \strong{ CreatePushUser } \emph{ Create a user from caller-supplied details (SAML, password, PAM, proxied, OAuth2 except with Google) }
...
#'
#' \itemize{
#' \item \emph{ @param } user \link{CreatePushUserRequest}
#' \item \emph{ @returnType } \link{User} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#' }
#'
#' \strong{ GetCurrentUser } \emph{ Get current user details }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested details about the current user.
#'
#' \item return type : User
#' \item response headers :
#'
...
#' }
#'
#' \strong{ GetUser } \emph{ Get user details }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested user details.
#'
#' \item return type : User
#' \item response headers :
#'
...
#' }
#'
#' \strong{ GetUsers } \emph{ List or search for user details }
...
#' \item \emph{ @param } user_role Enum < [administrator, publisher, viewer] >
#' \item \emph{ @param } account_status Enum < [locked, licensed, inactive] >
#' \item \emph{ @param } page_number integer
#' \item \emph{ @param } page_size integer
#' \item \emph{ @param } asc_order character
#' \item \emph{ @returnType } \link{Users} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The search results
#'
#' \item return type : Users
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ LockUser } \emph{ Lock a user }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } request \link{LockUserRequest}
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | This response is returned only when the lock/unlock request is successful.
#'
#'
#' \item response headers :
#'
...
#' }
#'
#' \strong{ SearchRemoteUsers } \emph{ Search for user details from a remote provider }
...
#' \item \emph{ @returnType } \link{RemoteSearchResults} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The search results.
#'
#' \item return type : RemoteSearchResults
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } user \link{UpdateUserRequest}
#' \item \emph{ @returnType } \link{EditableUser} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The latest user properties that can be modified by this endpoint.
#'
#' \item return type : EditableUser
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
UsersApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' Create a user using details from a remote authentication provider (LDAP, OAuth2 with Google) 
    #'
    #' @param request The request body needed for creating a user on the Posit Connect server.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return User
    #' @export
    CreatePullUser = function(request, data_file = NULL, ...) {
      local_var_response <- self$CreatePullUserWithHttpInfo(request, data_file = data_file, ...)
    ...
    #' @export
    CreatePullUserWithHttpInfo = function(request, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "User", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' @return User
    #' @export
    CreatePushUser = function(user, data_file = NULL, ...) {
      local_var_response <- self$CreatePushUserWithHttpInfo(user, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (User) with additional information such as HTTP status code, headers
    #' @export
    CreatePushUserWithHttpInfo = function(user, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @return User
    #' @export
    GetCurrentUser = function(data_file = NULL, ...) {
      local_var_response <- self$GetCurrentUserWithHttpInfo(data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (User) with additional information such as HTTP status code, headers
    #' @export
    GetCurrentUserWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' Get user details
    #'
    #' @param guid The user's GUID, or unique identifier  Example value = `6f300623-1e0c-48e6-a473-ddf630c0c0c3` using UUID [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return User
    #' @export
    GetUser = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetUserWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (User) with additional information such as HTTP status code, headers
    #' @export
    GetUserWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/users/{guid}"
      if (!missing(`guid`)) {
    ...
    #' List or search for user details
    #'
    #' @param prefix (optional) Filters users by prefix (username, first name, or last name). The filter is case insensitive.
    #' @param user_role (optional) Filter by user role. \"|\" represents logical OR. For example, `user_role=viewer|publisher` means users who are either a viewer or a publisher will be included in the result.  Note that for `user_role`, logical AND is also supported but always returns no results. For example, `user_role=viewer&user_role=publisher` tries to return users who are both viewers and publishers.
    #' @param account_status (optional) Filter by account status. \"|\" represents logical OR. For example, `account_status=locked|licensed` means users who are either locked or licensed. - `locked` - Users with a locked account. - `licensed` - Users regarded as licensed (unlocked and   recently active). - `inactive` - Users not locked and not recently active.  Note that for `account_status`, logical AND is also supported but always returns no results. For example, `account_status=locked&account_status=licensed` tries to return users who are both locked and licensed.
    #' @param page_number (optional) The page to return relative to the given `page_size`. If `page_number` is 0 or negative, an error will be returned. (default value: 1)
    #' @param page_size (optional) The number of items to include in each page. This parameter is \"best effort\" since there may not be enough users to honor the request. If `page_size` is less than 1 or greater than 500, an error will be returned. (default value: 20)
    #' @param asc_order (optional) Whether or not to return the users in ascending order, sorted by first name, last name, username, and email. (default value: TRUE)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Users
    #' @export
    GetUsers = function(prefix = NULL, user_role = NULL, account_status = NULL, page_number = 1, page_size = 20, asc_order = TRUE, data_file = NULL, ...) {
      local_var_response <- self$GetUsersWithHttpInfo(prefix, user_role, account_status, page_number, page_size, asc_order, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (Users) with additional information such as HTTP status code, headers
    #' @export
    GetUsersWithHttpInfo = function(prefix = NULL, user_role = NULL, account_status = NULL, page_number = 1, page_size = 20, asc_order = TRUE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (`page_number` < 1) {
        rlang::abort(message = "Invalid value for `page_number` when calling UsersApi$GetUsers, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `page_number` when calling UsersApi$GetUsers, must be bigger than or equal to 1."))
      }

      if (`page_size` > 500) {
        rlang::abort(message = "Invalid value for `page_size` when calling UsersApi$GetUsers, must be smaller than or equal to 500.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `page_size` when calling UsersApi$GetUsers, must be smaller than or equal to 500."))
      }
      if (`page_size` < 1) {
        rlang::abort(message = "Invalid value for `page_size` when calling UsersApi$GetUsers, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `page_size` when calling UsersApi$GetUsers, must be bigger than or equal to 1."))
      }
      ...
      if (!(`user_role` %in% c("administrator", "publisher", "viewer"))) {
        rlang::abort(message = "Invalid value for `user_role` when calling UsersApi$GetUsers. Must be [administrator, publisher, viewer].",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `user_role` when calling UsersApi$GetUsers. Must be [administrator, publisher, viewer]."))
      }
      query_params[["user_role"]] <- `user_role`

      if (!(`account_status` %in% c("locked", "licensed", "inactive"))) {
        rlang::abort(message = "Invalid value for `account_status` when calling UsersApi$GetUsers. Must be [locked, licensed, inactive].",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `account_status` when calling UsersApi$GetUsers. Must be [locked, licensed, inactive]."))
      }
      query_params[["account_status"]] <- `account_status`
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "Users", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return void
    #' @export
    LockUser = function(guid, request, ...) {
      local_var_response <- self$LockUserWithHttpInfo(guid, request, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    LockUserWithHttpInfo = function(guid, request, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/users/{guid}/lock"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
    ...
    #' Search for user details from a remote provider
    #'
    #' @param prefix Search users by prefix (username, first name, or last name). `prefix` is case insensitive.
    #' @param limit (optional) The maximum number of users to include in the results. If `limit` is less than 1 or greater than 500, an error will be returned. (default value: 20)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return RemoteSearchResults
    #' @export
    SearchRemoteUsers = function(prefix, limit = 20, data_file = NULL, ...) {
      local_var_response <- self$SearchRemoteUsersWithHttpInfo(prefix, limit, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (RemoteSearchResults) with additional information such as HTTP status code, headers
    #' @export
    SearchRemoteUsersWithHttpInfo = function(prefix, limit = 20, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (`limit` > 500) {
        rlang::abort(message = "Invalid value for `limit` when calling UsersApi$SearchRemoteUsers, must be smaller than or equal to 500.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `limit` when calling UsersApi$SearchRemoteUsers, must be smaller than or equal to 500."))
      }
      if (`limit` < 1) {
        rlang::abort(message = "Invalid value for `limit` when calling UsersApi$SearchRemoteUsers, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `limit` when calling UsersApi$SearchRemoteUsers, must be bigger than or equal to 1."))
      }
      ...
      local_var_url_path <- "/v1/users/remote"
      # API key authentication
      if ("Authorization" %in% names(self$api_client$api_keys) && nchar(self$api_client$api_keys["Authorization"]) > 0) {
        header_params["Authorization"] <- paste(unlist(self$api_client$api_keys["Authorization"]), collapse = "")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "RemoteSearchResults", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return EditableUser
    #' @export
    UpdateUser = function(guid, user, data_file = NULL, ...) {
      local_var_response <- self$UpdateUserWithHttpInfo(guid, user, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (EditableUser) with additional information such as HTTP status code, headers
    #' @export
    UpdateUserWithHttpInfo = function(guid, user, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "EditableUser", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
