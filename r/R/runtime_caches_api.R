...
#'
#' @docType class
#' @title RuntimeCaches operations
#' @description RuntimeCachesApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ DeleteRuntimeCache } \emph{ Delete a runtime cache }
...
#'
#' \itemize{
#' \item \emph{ @param } cache \link{DeleteRuntimeCacheRequest}
#' \item \emph{ @returnType } \link{DeleteRuntimeCacheResponse} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested deletion task.
#'
#' \item return type : DeleteRuntimeCacheResponse
...
#' \tabular{ll}{
#' }
#' \item status code : 401 | You do not have permission to perform this operation.
#'
#' \item return type : object
#' \item response headers :
#'
...
#' }
#'
#' \strong{ ListRuntimeCaches } \emph{ List runtime caches }
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link{RuntimeCaches} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The runtime caches found on the Connect server.
#'
#' \item return type : RuntimeCaches
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' @export
RuntimeCachesApi <- R6::R6Class(
  "RuntimeCachesApi",
  public = list(
    api_client = NULL,
    #' Initialize a new RuntimeCachesApi.
    #'
    #' @description
    #' Initialize a new RuntimeCachesApi.
    #'
    ...
    #' Delete a runtime cache
    #'
    #' @param cache The target runtime cache.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return DeleteRuntimeCacheResponse
    #' @export
    DeleteRuntimeCache = function(cache, data_file = NULL, ...) {
      local_var_response <- self$DeleteRuntimeCacheWithHttpInfo(cache, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (DeleteRuntimeCacheResponse) with additional information such as HTTP status code, headers
    #' @export
    DeleteRuntimeCacheWithHttpInfo = function(cache, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`cache`)) {
        rlang::abort(message = "Missing required parameter `cache`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Missing required parameter `cache`."))
      }


      if (!is.null(`cache`)) {
        local_var_body <- `cache`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/v1/system/caches/runtime"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "DeleteRuntimeCacheResponse", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' @export
    ListRuntimeCaches = function(data_file = NULL, ...) {
      local_var_response <- self$ListRuntimeCachesWithHttpInfo(data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (RuntimeCaches) with additional information such as HTTP status code, headers
    #' @export
    ListRuntimeCachesWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "RuntimeCaches", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
