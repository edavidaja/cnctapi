#' Create a new UpdateContentRequest
#'
#' @description
...
#' @description UpdateContentRequest Class
...
#' @field owner_guid The unique identifier of the user who owns this content item. It is automatically assigned when the content is created. Only administrators can change this value. character [optional]
...
#' @export
UpdateContentRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new UpdateContentRequest class.
    #'
    #' @description
    #' Initialize a new UpdateContentRequest class.
    #'
    ...
    #' @param owner_guid The unique identifier of the user who owns this content item. It is automatically assigned when the content is created. Only administrators can change this value.
    ...
    #' To JSON String
    #'
    #' @return UpdateContentRequest in JSON format
    #' @export
    toJSON = function() {
      UpdateContentRequestObject <- list()
      if (!is.null(self$`name`)) {
        UpdateContentRequestObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`title`)) {
        UpdateContentRequestObject[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`description`)) {
        UpdateContentRequestObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`access_type`)) {
        UpdateContentRequestObject[["access_type"]] <-
          self$`access_type`
      }
      if (!is.null(self$`owner_guid`)) {
        UpdateContentRequestObject[["owner_guid"]] <-
          self$`owner_guid`
      }
      if (!is.null(self$`connection_timeout`)) {
        UpdateContentRequestObject[["connection_timeout"]] <-
          self$`connection_timeout`
      }
      if (!is.null(self$`read_timeout`)) {
        UpdateContentRequestObject[["read_timeout"]] <-
          self$`read_timeout`
      }
      if (!is.null(self$`init_timeout`)) {
        UpdateContentRequestObject[["init_timeout"]] <-
          self$`init_timeout`
      }
      if (!is.null(self$`idle_timeout`)) {
        UpdateContentRequestObject[["idle_timeout"]] <-
          self$`idle_timeout`
      }
      if (!is.null(self$`max_processes`)) {
        UpdateContentRequestObject[["max_processes"]] <-
          self$`max_processes`
      }
      if (!is.null(self$`min_processes`)) {
        UpdateContentRequestObject[["min_processes"]] <-
          self$`min_processes`
      }
      if (!is.null(self$`max_conns_per_process`)) {
        UpdateContentRequestObject[["max_conns_per_process"]] <-
          self$`max_conns_per_process`
      }
      if (!is.null(self$`load_factor`)) {
        UpdateContentRequestObject[["load_factor"]] <-
          self$`load_factor`
      }
      if (!is.null(self$`cpu_request`)) {
        UpdateContentRequestObject[["cpu_request"]] <-
          self$`cpu_request`
      }
      if (!is.null(self$`cpu_limit`)) {
        UpdateContentRequestObject[["cpu_limit"]] <-
          self$`cpu_limit`
      }
      if (!is.null(self$`memory_request`)) {
        UpdateContentRequestObject[["memory_request"]] <-
          self$`memory_request`
      }
      if (!is.null(self$`memory_limit`)) {
        UpdateContentRequestObject[["memory_limit"]] <-
          self$`memory_limit`
      }
      if (!is.null(self$`run_as`)) {
        UpdateContentRequestObject[["run_as"]] <-
          self$`run_as`
      }
      if (!is.null(self$`run_as_current_user`)) {
        UpdateContentRequestObject[["run_as_current_user"]] <-
          self$`run_as_current_user`
      }
      if (!is.null(self$`default_image_name`)) {
        UpdateContentRequestObject[["default_image_name"]] <-
          self$`default_image_name`
      }
      if (!is.null(self$`default_r_environment_management`)) {
        UpdateContentRequestObject[["default_r_environment_management"]] <-
          self$`default_r_environment_management`
      }
      if (!is.null(self$`default_py_environment_management`)) {
        UpdateContentRequestObject[["default_py_environment_management"]] <-
          self$`default_py_environment_management`
      }
      if (!is.null(self$`service_account_name`)) {
        UpdateContentRequestObject[["service_account_name"]] <-
          self$`service_account_name`
      }
      UpdateContentRequestObject
    },
    #' Deserialize JSON string into an instance of UpdateContentRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of UpdateContentRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdateContentRequest
    #' @export
    ...
    #' Validate JSON input with respect to UpdateContentRequest
    #'
    #' @description
    #' Validate JSON input with respect to UpdateContentRequest and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UpdateContentRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UpdateContentRequest$unlock()
#
## Below is an example to define the print function
# UpdateContentRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UpdateContentRequest$lock()
