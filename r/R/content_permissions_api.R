...
#'
#' @docType class
#' @title ContentPermissions operations
#' @description ContentPermissionsApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ AddContentPermission } \emph{ Add permission }
#' Add a user or group to the permissions for this content item.
#'
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } permission \link{AddContentPermissionRequest}
#' \item \emph{ @returnType } \link{Permission} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The content permission entry that was added.
#'
#' \item return type : Permission
...
#' }
#'
#' \strong{ DeleteContentPermission } \emph{ Delete permission }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 204 | Returned when the permission entry is successfully deleted.
#'
#'
#' \item response headers :
#'
...
#' }
#'
#' \strong{ GetContentPermission } \emph{ Get permission }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The permission entry defining the permission level that  a user or group has been granted to the content item.
#'
#' \item return type : Permission
#' \item response headers :
#'
...
#' }
#'
#' \strong{ ListContentPermissions } \emph{ List permissions }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @returnType } list( \link{Permission} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of permissions associated with this content item.
#'
#' \item return type : array[Permission]
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ UpdateContentPermission } \emph{ Update permission }
#' Update a permission entry for this content item.
#'
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } id character
#' \item \emph{ @param } permission \link{UpdateContentPermissionRequest}
#' \item \emph{ @returnType } \link{Permission} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The updated content permission entry.
#'
#' \item return type : Permission
#' \item response headers :
#'
...
#' @export
ContentPermissionsApi <- R6::R6Class(
  "ContentPermissionsApi",
  public = list(
    api_client = NULL,
    #' Initialize a new ContentPermissionsApi.
    #'
    #' @description
    #' Initialize a new ContentPermissionsApi.
    #'
    ...
    #' @param permission The request body required when creating a new permission entry.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Permission
    #' @export
    AddContentPermission = function(guid, permission, data_file = NULL, ...) {
      local_var_response <- self$AddContentPermissionWithHttpInfo(guid, permission, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (Permission) with additional information such as HTTP status code, headers
    #' @export
    AddContentPermissionWithHttpInfo = function(guid, permission, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`permission`)) {
        rlang::abort(message = "Missing required parameter `permission`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Missing required parameter `permission`."))
      }



      if (!is.null(`permission`)) {
        local_var_body <- `permission`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/v1/content/{guid}/permissions"
      if (!missing(`guid`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "Permission", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #'
    #' @param guid The unique identifier of the desired content item.
    #' @param id The unique identifier of the permission entry.
    #' @param ... Other optional arguments
    #' @return void
    #' @export
    DeleteContentPermission = function(guid, id, ...) {
      local_var_response <- self$DeleteContentPermissionWithHttpInfo(guid, id, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    DeleteContentPermissionWithHttpInfo = function(guid, id, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/permissions/{id}"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
    ...
    #' @return Permission
    #' @export
    GetContentPermission = function(guid, id, data_file = NULL, ...) {
      local_var_response <- self$GetContentPermissionWithHttpInfo(guid, id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Permission) with additional information such as HTTP status code, headers
    #' @export
    GetContentPermissionWithHttpInfo = function(guid, id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @export
    ListContentPermissions = function(guid, data_file = NULL, ...) {
      local_var_response <- self$ListContentPermissionsWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[Permission]) with additional information such as HTTP status code, headers
    #' @export
    ListContentPermissionsWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[Permission]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #'
    #' @param guid The unique identifier of the desired content item.
    #' @param id The unique identifier of the permission entry to update.
    #' @param permission The request body required when creating a new permission entry.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Permission
    #' @export
    UpdateContentPermission = function(guid, id, permission, data_file = NULL, ...) {
      local_var_response <- self$UpdateContentPermissionWithHttpInfo(guid, id, permission, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Permission) with additional information such as HTTP status code, headers
    #' @export
    UpdateContentPermissionWithHttpInfo = function(guid, id, permission, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
