...
#'
#' @docType class
#' @title VanityURLs operations
#' @description VanityURLsApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ DeleteVanity } \emph{ Delete vanity URL }
...
#'
#' \item status code : 204 | Returned when the vanity URL was successfully removed.
#'
#'
...
#' }
#'
#' \strong{ GetVanity } \emph{ Get vanity URL }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @returnType } \link{GetVanity200Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The vanity URL definition for this content item, if any.
#'
#' \item return type : GetVanity200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ ListVanities } \emph{ List vanity URLs }
#' List all defined vanity URLs.  You must have administrator privileges to perform this action.
#'
#' \itemize{
#' \item \emph{ @returnType } list( \link{listVanities_200_response_inner} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | An array containing all defined vanity URLs.
#'
#' \item return type : array[ListVanities200ResponseInner]
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ SetVanity } \emph{ Set vanity URL }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } vanity \link{SetVanityRequest}
#' \item \emph{ @returnType } \link{SetVanity200Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The vanity URL definition that was created or updated.
#'
#' \item return type : SetVanity200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' @export
VanityURLsApi <- R6::R6Class(
  "VanityURLsApi",
  public = list(
    api_client = NULL,
    #' Initialize a new VanityURLsApi.
    #'
    #' @description
    #' Initialize a new VanityURLsApi.
    #'
    ...
    #' @return void
    #' @export
    DeleteVanity = function(guid, ...) {
      local_var_response <- self$DeleteVanityWithHttpInfo(guid, ...)
    ...
    #' @export
    DeleteVanityWithHttpInfo = function(guid, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/vanity"
      if (!missing(`guid`)) {
    ...
    #' @export
    GetVanity = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetVanityWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (GetVanity200Response) with additional information such as HTTP status code, headers
    #' @export
    GetVanityWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "GetVanity200Response", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' @export
    ListVanities = function(data_file = NULL, ...) {
      local_var_response <- self$ListVanitiesWithHttpInfo(data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[ListVanities200ResponseInner]) with additional information such as HTTP status code, headers
    #' @export
    ListVanitiesWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/vanities"
      # API key authentication
      if ("Authorization" %in% names(self$api_client$api_keys) && nchar(self$api_client$api_keys["Authorization"]) > 0) {
        header_params["Authorization"] <- paste(unlist(self$api_client$api_keys["Authorization"]), collapse = "")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[ListVanities200ResponseInner]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #'
    #' @param guid The unique identifier of the desired content item.
    #' @param vanity The vanity URL definition to apply to this content item.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return SetVanity200Response
    #' @export
    SetVanity = function(guid, vanity, data_file = NULL, ...) {
      local_var_response <- self$SetVanityWithHttpInfo(guid, vanity, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (SetVanity200Response) with additional information such as HTTP status code, headers
    #' @export
    SetVanityWithHttpInfo = function(guid, vanity, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`vanity`)) {
        rlang::abort(message = "Missing required parameter `vanity`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Missing required parameter `vanity`."))
      }



      if (!is.null(`vanity`)) {
        local_var_body <- `vanity`$toJSONString()
      } else {
        body <- NULL
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "SetVanity200Response", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
