...
class VanityURLsApi(object):
    ...
    def delete_vanity(self, guid, **kwargs):  # noqa: E501
        """Delete vanity URL  # noqa: E501

        Delete the vanity URL for this content.  If `Authorization.PublishersCanManageVanities` is `true`, publishers can delete the vanity URL for content items that they have permission to change. Otherwise, administrator permissions are required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_vanity(guid, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_vanity_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_vanity_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def delete_vanity_with_http_info(self, guid, **kwargs):  # noqa: E501
        """Delete vanity URL  # noqa: E501

        Delete the vanity URL for this content.  If `Authorization.PublishersCanManageVanities` is `true`, publishers can delete the vanity URL for content items that they have permission to change. Otherwise, administrator permissions are required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_vanity_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `delete_vanity`")  # noqa: E501
    ...
    def get_vanity(self, guid, **kwargs):  # noqa: E501
        """Get vanity URL  # noqa: E501

        Get the vanity URL, if any, defined for this content. If the content item has a vanity URL, it is returned. If there is no vanity URL for this content, a 404 status is returned.  Administrators can get the vanity URL for any content item. Any authenticated user who is authorized to view the content can get the vanity URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_vanity(guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_vanity_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_vanity_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def get_vanity_with_http_info(self, guid, **kwargs):  # noqa: E501
        """Get vanity URL  # noqa: E501

        Get the vanity URL, if any, defined for this content. If the content item has a vanity URL, it is returned. If there is no vanity URL for this content, a 404 status is returned.  Administrators can get the vanity URL for any content item. Any authenticated user who is authorized to view the content can get the vanity URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_vanity_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `get_vanity`")  # noqa: E501
    ...
    def list_vanities(self, **kwargs):  # noqa: E501
        """List vanity URLs  # noqa: E501

        List all defined vanity URLs.  You must have administrator privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_vanities(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_vanities_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_vanities_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_vanities_with_http_info(self, **kwargs):  # noqa: E501
        """List vanity URLs  # noqa: E501

        List all defined vanity URLs.  You must have administrator privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_vanities_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def set_vanity(self, body, guid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_vanity_with_http_info(body, guid, **kwargs)  # noqa: E501
        else:
            (data) = self.set_vanity_with_http_info(body, guid, **kwargs)  # noqa: E501
            return data

    def set_vanity_with_http_info(self, body, guid, **kwargs):  # noqa: E501
        """Set vanity URL  # noqa: E501

        Set the vanity URL for this content item.  A vanity URL path must meet certain requirements:  *   It must consist of alphanumeric characters, hyphens, underscores,     and slashes.  *   It cannot be a reserved path such as the root path `/`, or a path     beginning with `/__`.      *   The following path prefixes are prohibited:      * `/__`     * `/favicon.ico`     * `/connect`     * `/apps`     * `/users`     * `/groups`     * `/setpassword`     * `/user-completion`     * `/confirm`     * `/recent`     * `/reports`     * `/plots`     * `/unpublished`     * `/settings`     * `/metrics`     * `/tokens`     * `/help`     * `/login`     * `/welcome`     * `/register`     * `/resetpassword`     * `/content`     * _The custom location for the Connect dashboard, configured by [`Server.DashboardPath`](../appendix/configuration/#Server.DashboardPath)._  *   It cannot be an ancestor or descendant of an existing vanity URL     path. For example, if the vanity path `/a/b/` exists, you cannot     add `/a/` or `/a/b/c/`.  If `Authorization.PublishersCanManageVanities` is `true`, publishers can set the vanity URL for content items that they have permission to change. Otherwise, administrator permissions are required.  You can reassign an existing vanity URL to a different content item, if you are an administrator or collaborator/owner of both content items. You must set the `force` parameter to `true` to reassign a URL. An error will be returned if `force` is `false` and the URL already exists.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_vanity_with_http_info(body, guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `set_vanity`")  # noqa: E501
        # verify the required parameter 'guid' is set
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `set_vanity`")  # noqa: E501
