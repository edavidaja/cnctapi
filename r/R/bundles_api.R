...
#'
#' @docType class
#' @title Bundles operations
#' @description BundlesApi
...
#' \item \emph{ @param } guid character
#' \item \emph{ @param } id character
#' \item \emph{ @returnType } \link{Bundle} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The bundle details.
#'
#' \item return type : Bundle
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @returnType } list( \link{Bundle} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The list of bundles.
#'
#' \item return type : array[Bundle]
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ UploadContentBundle } \emph{ Create a bundle by uploading an archive }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The newly created bundle.
#'
#' \item return type : Bundle
#' \item response headers :
#'
...
#' @export
BundlesApi <- R6::R6Class(
  "BundlesApi",
  public = list(
    api_client = NULL,
    #' Initialize a new BundlesApi.
    #'
    #' @description
    #' Initialize a new BundlesApi.
    #'
    ...
    #' @return void
    #' @export
    DeleteBundle = function(guid, id, ...) {
      local_var_response <- self$DeleteBundleWithHttpInfo(guid, id, ...)
    ...
    #' @export
    DeleteBundleWithHttpInfo = function(guid, id, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/bundles/{id}"
      if (!missing(`guid`)) {
    ...
    #' @return data.frame
    #' @export
    DownloadBundle = function(guid, id, data_file = NULL, ...) {
      local_var_response <- self$DownloadBundleWithHttpInfo(guid, id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    DownloadBundleWithHttpInfo = function(guid, id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/bundles/{id}/download"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
    ...
    #' @return Bundle
    #' @export
    GetBundle = function(guid, id, data_file = NULL, ...) {
      local_var_response <- self$GetBundleWithHttpInfo(guid, id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (Bundle) with additional information such as HTTP status code, headers
    #' @export
    GetBundleWithHttpInfo = function(guid, id, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "Bundle", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return array[Bundle]
    #' @export
    GetBundles = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetBundlesWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[Bundle]) with additional information such as HTTP status code, headers
    #' @export
    GetBundlesWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/bundles"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[Bundle]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
