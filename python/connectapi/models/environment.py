...
class Environment(object):
    ...
    swagger_types = {
        ...
        'matching': 'str',
        'supervisor': 'str',
        'python': 'CreateEnvironmentInputPython',
        'quarto': 'CreateEnvironmentInputQuarto',
        'r': 'CreateEnvironmentInputR'
    }
    ...
    def __init__(self, id=None, guid=None, created_time=None, updated_time=None, title=None, description='null', cluster_name='Kubernetes', name=None, environment_type='Kubernetes', matching='any', supervisor='null', python=None, quarto=None, r=None):  # noqa: E501
    ...
    def id(self):
        ...
        The internal numeric identifier of this environment.  # noqa: E501
    ...
    @property
    def guid(self):
        """Gets the guid of this Environment.  # noqa: E501

        The unique identifier of this environment to be used with REST API requests.  # noqa: E501

        :return: The guid of this Environment.  # noqa: E501
        :rtype: str
        """
        return self._guid
    ...
    @guid.setter
    def guid(self, guid):
        """Sets the guid of this Environment.

        The unique identifier of this environment to be used with REST API requests.  # noqa: E501

        :param guid: The guid of this Environment.  # noqa: E501
        :type: str
        """
    ...
    def created_time(self):
        """Gets the created_time of this Environment.  # noqa: E501

        The timestamp (RFC3339) indicating when this environment was created.  # noqa: E501

        :return: The created_time of this Environment.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this Environment.

        The timestamp (RFC3339) indicating when this environment was created.  # noqa: E501

        :param created_time: The created_time of this Environment.  # noqa: E501
        :type: datetime
        """
    ...
    def updated_time(self):
        """Gets the updated_time of this Environment.  # noqa: E501

        The timestamp (RFC3339) indicating when this environment was last updated.  # noqa: E501

        :return: The updated_time of this Environment.  # noqa: E501
        :rtype: datetime
        """
    ...
    def updated_time(self, updated_time):
        """Sets the updated_time of this Environment.

        The timestamp (RFC3339) indicating when this environment was last updated.  # noqa: E501

        :param updated_time: The updated_time of this Environment.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def title(self):
        """Gets the title of this Environment.  # noqa: E501

        A human readable title for this environment.  # noqa: E501

        :return: The title of this Environment.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        ...
        :param title: The title of this Environment.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        ...
        A human readable description of this environment.  # noqa: E501
    ...
    def cluster_name(self):
        """Gets the cluster_name of this Environment.  # noqa: E501

        The cluster identifier for this environment.   The value is always \"Kubernetes\" when Off Host Execution is enabled.  # noqa: E501

        :return: The cluster_name of this Environment.  # noqa: E501
        :rtype: str
        """
    ...
    def cluster_name(self, cluster_name):
        """Sets the cluster_name of this Environment.

        The cluster identifier for this environment.   The value is always \"Kubernetes\" when Off Host Execution is enabled.  # noqa: E501

        :param cluster_name: The cluster_name of this Environment.  # noqa: E501
        :type: str
        """
    ...
    def name(self):
        ...
        The container image that will be used when executing content with this environment.  # noqa: E501
    ...
    def environment_type(self):
        """Gets the environment_type of this Environment.  # noqa: E501

        The type of environment.  The value is always \"Kubernetes\" when Off Host Execution is enabled.  # noqa: E501

        :return: The environment_type of this Environment.  # noqa: E501
        :rtype: str
        """
    ...
    def environment_type(self, environment_type):
        """Sets the environment_type of this Environment.

        The type of environment.  The value is always \"Kubernetes\" when Off Host Execution is enabled.  # noqa: E501

        :param environment_type: The environment_type of this Environment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def matching(self):
        """Gets the matching of this Environment.  # noqa: E501

        This field indicates how environments can be considered for selection when Posit Connect is choosing a compatible environment to use when executing content.  `any` (the default) indicates that the image can be selected by Connect automatically,   _or_ targeted in the bundle's manifest.  `exact` indicates the image must be explicitly asked for in the bundle's manifest.  `none` indicates that the image should never be selected by Posit Connect.  # noqa: E501

        :return: The matching of this Environment.  # noqa: E501
        :rtype: str
        """
    ...
    def matching(self, matching):
        """Sets the matching of this Environment.

        This field indicates how environments can be considered for selection when Posit Connect is choosing a compatible environment to use when executing content.  `any` (the default) indicates that the image can be selected by Connect automatically,   _or_ targeted in the bundle's manifest.  `exact` indicates the image must be explicitly asked for in the bundle's manifest.  `none` indicates that the image should never be selected by Posit Connect.  # noqa: E501

        :param matching: The matching of this Environment.  # noqa: E501
        :type: str
        """
        allowed_values = ["any", "exact", "none"]  # noqa: E501
        if matching not in allowed_values:
            raise ValueError(
                "Invalid value for `matching` ({0}), must be one of {1}"  # noqa: E501
                .format(matching, allowed_values)
            )
    ...
    @property
    def supervisor(self):
        """Gets the supervisor of this Environment.  # noqa: E501

        The path to the script or command that should be used as the [program supervisor](https://docs.posit.co/helm/rstudio-connect/kubernetes-howto/appendices/content_images.html#per-image-supervisors) when executing content with this environment.  # noqa: E501

        :return: The supervisor of this Environment.  # noqa: E501
        :rtype: str
        """
    ...
    def supervisor(self, supervisor):
        """Sets the supervisor of this Environment.

        The path to the script or command that should be used as the [program supervisor](https://docs.posit.co/helm/rstudio-connect/kubernetes-howto/appendices/content_images.html#per-image-supervisors) when executing content with this environment.  # noqa: E501

        :param supervisor: The supervisor of this Environment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def python(self):
        """Gets the python of this Environment.  # noqa: E501


        :return: The python of this Environment.  # noqa: E501
        :rtype: CreateEnvironmentInputPython
        """
        return self._python

    @python.setter
    def python(self, python):
        """Sets the python of this Environment.


        :param python: The python of this Environment.  # noqa: E501
        :type: CreateEnvironmentInputPython
        """
    ...
    @property
    def quarto(self):
        """Gets the quarto of this Environment.  # noqa: E501


        :return: The quarto of this Environment.  # noqa: E501
        :rtype: CreateEnvironmentInputQuarto
        """
        return self._quarto

    @quarto.setter
    def quarto(self, quarto):
        """Sets the quarto of this Environment.


        :param quarto: The quarto of this Environment.  # noqa: E501
        :type: CreateEnvironmentInputQuarto
        """
    ...
    @property
    def r(self):
        """Gets the r of this Environment.  # noqa: E501


        :return: The r of this Environment.  # noqa: E501
        :rtype: CreateEnvironmentInputR
        """
        return self._r

    @r.setter
    def r(self, r):
        """Sets the r of this Environment.


        :param r: The r of this Environment.  # noqa: E501
        :type: CreateEnvironmentInputR
        """
