...
class ContentGuidBody(object):
    ...
    def __init__(self, name='', title='null', description='', access_type='acl', owner_guid=None, connection_timeout=None, read_timeout=None, init_timeout=None, idle_timeout=None, max_processes=None, min_processes=None, max_conns_per_process=None, load_factor=None, cpu_request=None, cpu_limit=None, memory_request=None, memory_limit=None, run_as='null', run_as_current_user=False, default_image_name=None, default_r_environment_management=False, default_py_environment_management=False, service_account_name='null'):  # noqa: E501
        """ContentGuidBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._title = None
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ContentGuidBody.

        A simple, URL-friendly identifier. Allows alpha-numeric characters, hyphens (`\"-\"`), and underscores (`\"_\"`).  # noqa: E501

        :param name: The name of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def title(self):
        """Gets the title of this ContentGuidBody.  # noqa: E501

        The title of this content.  # noqa: E501

        :return: The title of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ContentGuidBody.

        The title of this content.  # noqa: E501

        :param title: The title of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ContentGuidBody.  # noqa: E501

        A rich description of this content.  # noqa: E501

        :return: The description of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ContentGuidBody.

        A rich description of this content.  # noqa: E501

        :param description: The description of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    def access_type(self):
        """Gets the access_type of this ContentGuidBody.  # noqa: E501
        ...
        :return: The access_type of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
    ...
    def access_type(self, access_type):
        """Sets the access_type of this ContentGuidBody.

        Access type describes how this content manages its viewers. The value `all` is the most permissive; any visitor to Posit Connect will be able to view this content. The value `logged_in` indicates that all Posit Connect accounts may view the content. The `acl` value lets specifically enumerated users and groups view the content. Users configured as collaborators may always view content.  # noqa: E501

        :param access_type: The access_type of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def owner_guid(self):
        """Gets the owner_guid of this ContentGuidBody.  # noqa: E501

        The unique identifier of the user who owns this content item. It is automatically assigned when the content is created. Only administrators can change this value.  # noqa: E501

        :return: The owner_guid of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
    ...
    def owner_guid(self, owner_guid):
        """Sets the owner_guid of this ContentGuidBody.

        The unique identifier of the user who owns this content item. It is automatically assigned when the content is created. Only administrators can change this value.  # noqa: E501

        :param owner_guid: The owner_guid of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    def connection_timeout(self):
        """Gets the connection_timeout of this ContentGuidBody.  # noqa: E501
        ...
        :return: The connection_timeout of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def connection_timeout(self, connection_timeout):
        """Sets the connection_timeout of this ContentGuidBody.

        Maximum number of seconds allowed without data sent or received across a client connection. A value of `0` means connections will never time-out (not recommended). When `null`, the default `Scheduler.ConnectionTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param connection_timeout: The connection_timeout of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def read_timeout(self):
        """Gets the read_timeout of this ContentGuidBody.  # noqa: E501
        ...
        :return: The read_timeout of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def read_timeout(self, read_timeout):
        """Sets the read_timeout of this ContentGuidBody.

        Maximum number of seconds allowed without data received from a client connection. A value of `0` means a lack of client (browser) interaction never causes the connection to close. When `null`, the default `Scheduler.ReadTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param read_timeout: The read_timeout of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def init_timeout(self):
        """Gets the init_timeout of this ContentGuidBody.  # noqa: E501
        ...
        :return: The init_timeout of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def init_timeout(self, init_timeout):
        """Sets the init_timeout of this ContentGuidBody.

        The maximum number of seconds allowed for an interactive application to start. Posit Connect must be able to connect to a newly launched application before this threshold has elapsed. When `null`, the default `Scheduler.InitTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param init_timeout: The init_timeout of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def idle_timeout(self):
        """Gets the idle_timeout of this ContentGuidBody.  # noqa: E501
        ...
        :return: The idle_timeout of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def idle_timeout(self, idle_timeout):
        """Sets the idle_timeout of this ContentGuidBody.

        The maximum number of seconds a worker process for an interactive application to remain alive after it goes idle (no active connections). When `null`, the default `Scheduler.IdleTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param idle_timeout: The idle_timeout of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def max_processes(self):
        """Gets the max_processes of this ContentGuidBody.  # noqa: E501

        Specifies the total number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MaxProcesses` is used. Applies only to content types that are executed on demand.  The value cannot be greater than `Scheduler.MaxProcessesLimit`.  # noqa: E501

        :return: The max_processes of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def max_processes(self, max_processes):
        """Sets the max_processes of this ContentGuidBody.

        Specifies the total number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MaxProcesses` is used. Applies only to content types that are executed on demand.  The value cannot be greater than `Scheduler.MaxProcessesLimit`.  # noqa: E501

        :param max_processes: The max_processes of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def min_processes(self):
        """Gets the min_processes of this ContentGuidBody.  # noqa: E501

        Specifies the minimum number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MinProcesses` is used. Applies only to content types that are executed on demand.  The value cannot be greater than `Scheduler.MinProcessesLimit`.  # noqa: E501

        :return: The min_processes of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def min_processes(self, min_processes):
        """Sets the min_processes of this ContentGuidBody.

        Specifies the minimum number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MinProcesses` is used. Applies only to content types that are executed on demand.  The value cannot be greater than `Scheduler.MinProcessesLimit`.  # noqa: E501

        :param min_processes: The min_processes of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def max_conns_per_process(self):
        """Gets the max_conns_per_process of this ContentGuidBody.  # noqa: E501
        ...
        :return: The max_conns_per_process of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def max_conns_per_process(self, max_conns_per_process):
        """Sets the max_conns_per_process of this ContentGuidBody.

        Specifies the maximum number of client connections allowed to an individual process. Incoming connections which will exceed this limit are routed to a new process or rejected. When `null`, the default `Scheduler.MaxConnsPerProcess` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param max_conns_per_process: The max_conns_per_process of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def load_factor(self):
        """Gets the load_factor of this ContentGuidBody.  # noqa: E501

        Controls how aggressively new processes are spawned. When `null`, the default `Scheduler.LoadFactor` is used. Applies only to content types that are executed on demand.  The valid range is between 0.0 and 1.0.  # noqa: E501

        :return: The load_factor of this ContentGuidBody.  # noqa: E501
        :rtype: float
        """
    ...
    def load_factor(self, load_factor):
        """Sets the load_factor of this ContentGuidBody.

        Controls how aggressively new processes are spawned. When `null`, the default `Scheduler.LoadFactor` is used. Applies only to content types that are executed on demand.  The valid range is between 0.0 and 1.0.  # noqa: E501

        :param load_factor: The load_factor of this ContentGuidBody.  # noqa: E501
        :type: float
        """
    ...
    def cpu_request(self):
        """Gets the cpu_request of this ContentGuidBody.  # noqa: E501

        The minimum amount of compute power this content needs when executing or rendering, expressed in [\"CPU Units\"](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-cpu), where 1.0 unit is equivalent to 1 physical or virtual core. Fractional values are allowed. This is used when running in an off-host execution configuration to determine where the content should be run. When `null`, the default `Scheduler.CPURequest` is used.  The value cannot be greater than `Scheduler.MaxCPURequest`, or than the effective `cpu_limit`.  # noqa: E501

        :return: The cpu_request of this ContentGuidBody.  # noqa: E501
        :rtype: float
        """
    ...
    def cpu_request(self, cpu_request):
        """Sets the cpu_request of this ContentGuidBody.

        The minimum amount of compute power this content needs when executing or rendering, expressed in [\"CPU Units\"](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-cpu), where 1.0 unit is equivalent to 1 physical or virtual core. Fractional values are allowed. This is used when running in an off-host execution configuration to determine where the content should be run. When `null`, the default `Scheduler.CPURequest` is used.  The value cannot be greater than `Scheduler.MaxCPURequest`, or than the effective `cpu_limit`.  # noqa: E501

        :param cpu_request: The cpu_request of this ContentGuidBody.  # noqa: E501
        :type: float
        """
    ...
    @property
    def cpu_limit(self):
        """Gets the cpu_limit of this ContentGuidBody.  # noqa: E501

        The maximum amount of compute power this content will be allowed to consume when executing or rendering, expressed in [\"CPU Units\"](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-cpu), where 1.0 unit is equivalent to 1 physical or virtual core. Fractional values are allowed. This is used when running in an off-host execution configuration. If the process tries to use more CPU than allowed, it will be throttled. When `null`, the default `Scheduler.CPULimit` is used.  The value cannot be greater than `Scheduler.MaxCPULimit`, or less than the effective `cpu_request`.  # noqa: E501

        :return: The cpu_limit of this ContentGuidBody.  # noqa: E501
        :rtype: float
        """
    ...
    def cpu_limit(self, cpu_limit):
        """Sets the cpu_limit of this ContentGuidBody.

        The maximum amount of compute power this content will be allowed to consume when executing or rendering, expressed in [\"CPU Units\"](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-cpu), where 1.0 unit is equivalent to 1 physical or virtual core. Fractional values are allowed. This is used when running in an off-host execution configuration. If the process tries to use more CPU than allowed, it will be throttled. When `null`, the default `Scheduler.CPULimit` is used.  The value cannot be greater than `Scheduler.MaxCPULimit`, or less than the effective `cpu_request`.  # noqa: E501

        :param cpu_limit: The cpu_limit of this ContentGuidBody.  # noqa: E501
        :type: float
        """
    ...
    def memory_request(self):
        """Gets the memory_request of this ContentGuidBody.  # noqa: E501

        The minimum amount of RAM this content needs when executing or rendering, expressed in bytes. This is used when running in an off-host execution configuration to determine where the content should be run. When `null`, the default `Scheduler.MemoryRequest` is used.  The value cannot be greater than `Scheduler.MaxMemoryRequest`, or than the effective `memory_limit`.  # noqa: E501

        :return: The memory_request of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def memory_request(self, memory_request):
        """Sets the memory_request of this ContentGuidBody.

        The minimum amount of RAM this content needs when executing or rendering, expressed in bytes. This is used when running in an off-host execution configuration to determine where the content should be run. When `null`, the default `Scheduler.MemoryRequest` is used.  The value cannot be greater than `Scheduler.MaxMemoryRequest`, or than the effective `memory_limit`.  # noqa: E501

        :param memory_request: The memory_request of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    def memory_limit(self):
        """Gets the memory_limit of this ContentGuidBody.  # noqa: E501
        ...
        :return: The memory_limit of this ContentGuidBody.  # noqa: E501
        :rtype: int
        """
    ...
    def memory_limit(self, memory_limit):
        """Sets the memory_limit of this ContentGuidBody.

        The maximum amount of RAM this content will be allowed to consume when executing or rendering, expressed in bytes. If the process tries to use more memory than allowed, it will be terminated. When `null`, the default `Scheduler.MemoryLimit` is used.  The value cannot be greater than `Scheduler.MaxMemoryLimit`, or less than the effective `memory_request`.  # noqa: E501

        :param memory_limit: The memory_limit of this ContentGuidBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def run_as(self):
        """Gets the run_as of this ContentGuidBody.  # noqa: E501
        ...
        :return: The run_as of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
        return self._run_as
    ...
    def run_as(self, run_as):
        """Sets the run_as of this ContentGuidBody.

        The UNIX user that executes this content. When `null`, the default `Applications.RunAs` is used. Applies only to executable content types - not `static`.  Only administrators can change this value.  # noqa: E501

        :param run_as: The run_as of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    def run_as_current_user(self):
        """Gets the run_as_current_user of this ContentGuidBody.  # noqa: E501
        ...
        :return: The run_as_current_user of this ContentGuidBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_as_current_user(self, run_as_current_user):
        """Sets the run_as_current_user of this ContentGuidBody.

        Indicates that Connect should run processes for this content item under the Unix account of the user who visits it. Content accessed anonymously will continue to run as the specified `run_as` user.  Connect must be configured to use PAM authentication with the server settings `Applications.RunAsCurrentUser = true` and `PAM.ForwardPassword = true`. This setting has no effect for other authentication types.  This setting only applies to application content types (Shiny, Dash, Streamlit, and Bokeh).  Only administrators can change this value.  # noqa: E501

        :param run_as_current_user: The run_as_current_user of this ContentGuidBody.  # noqa: E501
        :type: bool
        """
    ...
    def default_image_name(self):
        """Gets the default_image_name of this ContentGuidBody.  # noqa: E501
        ...
        :return: The default_image_name of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
    ...
    def default_image_name(self, default_image_name):
        """Sets the default_image_name of this ContentGuidBody.

        The default image that will be used when none is defined by the bundle's manifest. A specific image may be selected by setting the `environment.image` field in the manifest. If no image is selected by the manifest file, then the `default_image_name` is used. If a target image is not defined by the manifest, and no `default_image_name` is configured, then Connect will select an image from the list of configured execution environments.  Use the `/v1/environments` API endpoints to determine which environments are available for content execution.  # noqa: E501

        :param default_image_name: The default_image_name of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    def default_r_environment_management(self):
        """Gets the default_r_environment_management of this ContentGuidBody.  # noqa: E501

        Indicates whether or not Connect should create and manage an R environment (installing required packages) for this content. When `null`, Connect makes this determination based on the server configuration.  This value is ignored if the server setting `Applications.DefaultEnvironmentManagementSelection` is disabled.  # noqa: E501

        :return: The default_r_environment_management of this ContentGuidBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def default_r_environment_management(self, default_r_environment_management):
        """Sets the default_r_environment_management of this ContentGuidBody.

        Indicates whether or not Connect should create and manage an R environment (installing required packages) for this content. When `null`, Connect makes this determination based on the server configuration.  This value is ignored if the server setting `Applications.DefaultEnvironmentManagementSelection` is disabled.  # noqa: E501

        :param default_r_environment_management: The default_r_environment_management of this ContentGuidBody.  # noqa: E501
        :type: bool
        """
    ...
    def default_py_environment_management(self):
        """Gets the default_py_environment_management of this ContentGuidBody.  # noqa: E501

        Indicates whether or not Connect should create and manage a Python environment (installing required packages) for this content. When `null`, Connect makes this determination based on the server configuration.  This value is ignored if the server setting `Applications.DefaultEnvironmentManagementSelection` is disabled.  # noqa: E501

        :return: The default_py_environment_management of this ContentGuidBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def default_py_environment_management(self, default_py_environment_management):
        """Sets the default_py_environment_management of this ContentGuidBody.

        Indicates whether or not Connect should create and manage a Python environment (installing required packages) for this content. When `null`, Connect makes this determination based on the server configuration.  This value is ignored if the server setting `Applications.DefaultEnvironmentManagementSelection` is disabled.  # noqa: E501

        :param default_py_environment_management: The default_py_environment_management of this ContentGuidBody.  # noqa: E501
        :type: bool
        """
    ...
    def service_account_name(self):
        """Gets the service_account_name of this ContentGuidBody.  # noqa: E501
        ...
        :return: The service_account_name of this ContentGuidBody.  # noqa: E501
        :rtype: str
        """
    ...
    def service_account_name(self, service_account_name):
        """Sets the service_account_name of this ContentGuidBody.

        The name of the Kubernetes service account that is used to run a particular piece of content.  It must adhere to valid Kubernetes service account naming rules.  Connect must be configured to run with `Launcher.Enabled = true`, `Launcher.Kubernetes = true` and `Launcher.KubernetesContentServiceAccountSelection = true`  for this value to be applied. It will have precedence over the `Launcher.KubernetesDefaultServiceAccount` that may be set in the configuration for Connect.  If this value is defined and Connect is configured with `Launcher.KubernetesContentServiceAccountSelection = false` an error will be returned.  Only administrators and publishers can view this value. Only administrators can set or change this value.  # noqa: E501

        :param service_account_name: The service_account_name of this ContentGuidBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContentGuidBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentGuidBody):
            return False
