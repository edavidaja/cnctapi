...
#' @field results The groups list list(\link{Group}) [optional]
...
Groups <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return Groups in JSON format
    #' @export
    toJSON = function() {
      GroupsObject <- list()
      if (!is.null(self$`current_page`)) {
        GroupsObject[["current_page"]] <-
          self$`current_page`
      }
    ...
    #' Deserialize JSON string into an instance of Groups
    #'
    #' @description
    #' Deserialize JSON string into an instance of Groups
    #'
    #' @param input_json the JSON input
    #' @return the instance of Groups
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[Group]", loadNamespace("connectapi2"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to Groups
    #'
    #' @description
    #' Validate JSON input with respect to Groups and throw an exception if invalid
    #'
...
# Groups$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
