...
#' \item \emph{ @returnType } \link{GetTask200Response1} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The task details.
#'
#' \item return type : GetTask200Response1
...
TasksApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (GetTask200Response1) with additional information such as HTTP status code, headers
    #' @export
    GetTaskWithHttpInfo = function(id, first = 0, wait = 0, data_file = NULL, ...) {
      ...
      local_var_url_path <- "/v1/tasks/{id}"
      if (!missing(`id`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "GetTask200Response1", loadNamespace("connectapi2")),
          error = function(e) {
