...
#' @description EnvironmentsApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ CreateEnvironment } \emph{ Create execution environment }
#' Create a new execution environment.  You must have administrator privileges to perform this action.
#'
#' \itemize{
#' \item \emph{ @param } environment \link{CreateEnvironmentInput}
#' \item \emph{ @returnType } \link{Environment} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The details for the newly created execution environment.
#'
...
#' }
#'
#' \strong{ DeleteEnvironment } \emph{ Delete an execution environment }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 204 | Returned when the environment was successfully removed.
#'
#'
#' \item response headers :
#'
...
#' }
#'
#' \strong{ GetEnvironment } \emph{ Get execution environment details }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested environment details.
#'
#' \item return type : Environment
#' \item response headers :
#'
...
#' }
#'
#' \strong{ ListEnvironments } \emph{ List execution environments }
...
#'
#' \itemize{
#' \item \emph{ @returnType } list( \link{Environment} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | An array containing all available execution environments.
#'
#' \item return type : array[Environment]
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ UpdateEnvironment } \emph{ Update an execution environment }
#' Update a specific execution environment.  You must have administrator privileges to perform this action.
#'
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } environment \link{UpdateEnvironmentInput}
#' \item \emph{ @returnType } \link{Environment} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The details for the updated execution environment.
#'
#' \item return type : Environment
#' \item response headers :
#'
...
EnvironmentsApi <- R6::R6Class(
  ...
  public = list(
    api_client = NULL,
    #' Initialize a new EnvironmentsApi.
    #'
    #' @description
    #' Initialize a new EnvironmentsApi.
    #'
    ...
    #' Create execution environment
    #'
    #' @param environment The request body required when creating a new execution environment.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Environment
    #' @export
    CreateEnvironment = function(environment, data_file = NULL, ...) {
      local_var_response <- self$CreateEnvironmentWithHttpInfo(environment, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (Environment) with additional information such as HTTP status code, headers
    #' @export
    CreateEnvironmentWithHttpInfo = function(environment, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`environment`)) {
        local_var_body <- `environment`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/v1/environments"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "Environment", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' Delete an execution environment
    #'
    #' @param guid The unique identifier of the desired environment.
    #' @param ... Other optional arguments
    #' @return void
    #' @export
    DeleteEnvironment = function(guid, ...) {
      local_var_response <- self$DeleteEnvironmentWithHttpInfo(guid, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    DeleteEnvironmentWithHttpInfo = function(guid, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/environments/{guid}"
      if (!missing(`guid`)) {
    ...
    #' @return Environment
    #' @export
    GetEnvironment = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetEnvironmentWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Environment) with additional information such as HTTP status code, headers
    #' @export
    GetEnvironmentWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @export
    ListEnvironments = function(data_file = NULL, ...) {
      local_var_response <- self$ListEnvironmentsWithHttpInfo(data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[Environment]) with additional information such as HTTP status code, headers
    #' @export
    ListEnvironmentsWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[Environment]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return Environment
    #' @export
    UpdateEnvironment = function(guid, environment, data_file = NULL, ...) {
      local_var_response <- self$UpdateEnvironmentWithHttpInfo(guid, environment, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Environment) with additional information such as HTTP status code, headers
    #' @export
    UpdateEnvironmentWithHttpInfo = function(guid, environment, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
