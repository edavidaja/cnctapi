#' Create a new GetVanity200Response
#'
#' @description
#' The fields that are returned when getting or listing vanity URLs.
#'
#' @docType class
#' @title GetVanity200Response
#' @description GetVanity200Response Class
...
#' @export
GetVanity200Response <- R6::R6Class(
  "GetVanity200Response",
  public = list(
    `path` = NULL,
    `content_guid` = NULL,
    `created_time` = NULL,
    #' Initialize a new GetVanity200Response class.
    #'
    #' @description
    #' Initialize a new GetVanity200Response class.
    #'
    ...
    #' To JSON String
    #'
    #' @return GetVanity200Response in JSON format
    #' @export
    toJSON = function() {
      GetVanity200ResponseObject <- list()
      if (!is.null(self$`path`)) {
        GetVanity200ResponseObject[["path"]] <-
          self$`path`
      }
      if (!is.null(self$`content_guid`)) {
        GetVanity200ResponseObject[["content_guid"]] <-
          self$`content_guid`
      }
      if (!is.null(self$`created_time`)) {
        GetVanity200ResponseObject[["created_time"]] <-
          self$`created_time`
      }
      GetVanity200ResponseObject
    },
    #' Deserialize JSON string into an instance of GetVanity200Response
    #'
    #' @description
    #' Deserialize JSON string into an instance of GetVanity200Response
    #'
    #' @param input_json the JSON input
    #' @return the instance of GetVanity200Response
    #' @export
    ...
    #' Validate JSON input with respect to GetVanity200Response
    #'
    #' @description
    #' Validate JSON input with respect to GetVanity200Response and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GetVanity200Response
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GetVanity200Response$unlock()
#
## Below is an example to define the print function
# GetVanity200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GetVanity200Response$lock()
