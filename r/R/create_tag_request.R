...
#' @description CreateTagRequest Class
...
#' @export
CreateTagRequest <- R6::R6Class(
  "CreateTagRequest",
  public = list(
    `name` = NULL,
    `parent_id` = NULL,
    #' Initialize a new CreateTagRequest class.
    #'
    #' @description
    #' Initialize a new CreateTagRequest class.
    #'
    ...
    #' To JSON String
    #'
    #' @return CreateTagRequest in JSON format
    #' @export
    toJSON = function() {
      CreateTagRequestObject <- list()
      if (!is.null(self$`name`)) {
        CreateTagRequestObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`parent_id`)) {
        CreateTagRequestObject[["parent_id"]] <-
          self$`parent_id`
      }
      CreateTagRequestObject
    },
    #' Deserialize JSON string into an instance of CreateTagRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of CreateTagRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreateTagRequest
    #' @export
    ...
    #' Validate JSON input with respect to CreateTagRequest
    #'
    #' @description
    #' Validate JSON input with respect to CreateTagRequest and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CreateTagRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CreateTagRequest$unlock()
#
## Below is an example to define the print function
# CreateTagRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreateTagRequest$lock()
