...
#'
#' @docType class
#' @title TasksV1Experimental operations
#' @description TasksV1ExperimentalApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ GetTask } \emph{ Get task details }
...
#' \item \emph{ @param } first integer
#' \item \emph{ @param } wait integer
#' \item \emph{ @returnType } \link{GetTask200Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The task details.
#'
#' \item return type : GetTask200Response
...
#' @export
TasksV1ExperimentalApi <- R6::R6Class(
  "TasksV1ExperimentalApi",
  public = list(
    api_client = NULL,
    #' Initialize a new TasksV1ExperimentalApi.
    #'
    #' @description
    #' Initialize a new TasksV1ExperimentalApi.
    #'
    ...
    #' Get task details
    #'
    #' @param id The identifier of the desired task.
    #' @param first (optional) The first line of output to include in the response. The value `0` indicates that all lines should be returned.  Values less than `0` are not permitted. Values greater than the total number of lines produced by the task are not permitted. (default value: 0)
    #' @param wait (optional) The number of seconds to wait for task completion before responding. The current state of the task is returned once the task completes or this time elapses.  Values less than `0` or greater than `20` are not permitted. (default value: 0)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return GetTask200Response
    #' @export
    GetTask = function(id, first = 0, wait = 0, data_file = NULL, ...) {
      local_var_response <- self$GetTaskWithHttpInfo(id, first, wait, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (GetTask200Response) with additional information such as HTTP status code, headers
    #' @export
    GetTaskWithHttpInfo = function(id, first = 0, wait = 0, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/experimental/tasks/{id}"
      if (!missing(`id`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "GetTask200Response", loadNamespace("connectapi2")),
          error = function(e) {
