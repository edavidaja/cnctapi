...
class EnvironmentsApi(object):
    ...
    def create_environment(self, body, **kwargs):  # noqa: E501
        """Create execution environment  # noqa: E501

        Create a new execution environment.  You must have administrator privileges to perform this action.  # noqa: E501
        ...
        :param CreateEnvironmentInput body: The request body required when creating a new execution environment. (required)
        :return: Environment
    ...
    def delete_environment(self, guid, **kwargs):  # noqa: E501
        """Delete an execution environment  # noqa: E501

        Delete a specific execution environment.  You must have administrator privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_environment(guid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str guid: The unique identifier of the desired environment. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_environment_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_environment_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def delete_environment_with_http_info(self, guid, **kwargs):  # noqa: E501
        """Delete an execution environment  # noqa: E501

        Delete a specific execution environment.  You must have administrator privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_environment_with_http_info(guid, async_req=True)
        >>> result = thread.get()
    ...
    def get_environment(self, guid, **kwargs):  # noqa: E501
        """Get execution environment details  # noqa: E501

        Get detailed information about a specific execution environment.  You must have administrator or publisher privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_environment(guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_environment_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_environment_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def get_environment_with_http_info(self, guid, **kwargs):  # noqa: E501
        """Get execution environment details  # noqa: E501

        Get detailed information about a specific execution environment.  You must have administrator or publisher privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_environment_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `get_environment`")  # noqa: E501
    ...
    def list_environments(self, **kwargs):  # noqa: E501
        """List execution environments  # noqa: E501

        List all execution environments available to Posit Connect.  You must have administrator or publisher privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_environment(self, body, guid, **kwargs):  # noqa: E501
        """Update an execution environment  # noqa: E501

        Update a specific execution environment.  You must have administrator privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_environment(body, guid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateEnvironmentInput body: The request body required when creating a new execution environment. (required)
        :param str guid: The unique identifier of the desired environment. (required)
        :return: Environment
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_environment_with_http_info(body, guid, **kwargs)  # noqa: E501
        else:
            (data) = self.update_environment_with_http_info(body, guid, **kwargs)  # noqa: E501
            return data

    def update_environment_with_http_info(self, body, guid, **kwargs):  # noqa: E501
        """Update an execution environment  # noqa: E501

        Update a specific execution environment.  You must have administrator privileges to perform this action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_environment_with_http_info(body, guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `update_environment`")  # noqa: E501
