...
class ContentV1Exp(object):
    ...
    def __init__(self, guid=None, name='', title='null', description='', access_type='acl', connection_timeout=None, read_timeout=None, init_timeout=None, idle_timeout=None, max_processes=None, min_processes=None, max_conns_per_process=None, load_factor=None, created_time=None, last_deployed_time=None, bundle_id=None, app_mode=None, content_category=None, has_parameters=None, cluster_name=None, image_name=None, r_version=None, py_version=None, quarto_version=None, run_as='null', run_as_current_user=False, owner_guid=None, url=None, role=None):  # noqa: E501
        """ContentV1Exp - a model defined in Swagger"""  # noqa: E501
        self._guid = None
        self._name = None
        self._title = None
    ...
    @property
    def guid(self):
        """Gets the guid of this ContentV1Exp.  # noqa: E501

        The unique identifier of this content item.  # noqa: E501

        :return: The guid of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
        return self._guid
    ...
    @guid.setter
    def guid(self, guid):
        """Sets the guid of this ContentV1Exp.

        The unique identifier of this content item.  # noqa: E501

        :param guid: The guid of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ContentV1Exp.

        A simple, URL-friendly identifier. Allows alpha-numeric characters, hyphens (`\"-\"`), and underscores (`\"_\"`).  # noqa: E501

        :param name: The name of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def title(self):
        """Gets the title of this ContentV1Exp.  # noqa: E501

        The title of this content.  # noqa: E501

        :return: The title of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ContentV1Exp.

        The title of this content.  # noqa: E501

        :param title: The title of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ContentV1Exp.  # noqa: E501

        A rich description of this content.  # noqa: E501

        :return: The description of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ContentV1Exp.

        A rich description of this content.  # noqa: E501

        :param description: The description of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def access_type(self):
        """Gets the access_type of this ContentV1Exp.  # noqa: E501
        ...
        :return: The access_type of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def access_type(self, access_type):
        """Sets the access_type of this ContentV1Exp.

        Access type describes how this content manages its viewers. The value `all` is the most permissive; any visitor to Posit Connect will be able to view this content. The value `logged_in` indicates that all Posit Connect accounts may view the content. The `acl` value lets specifically enumerated users and groups view the content. Users configured as collaborators may always view content.  # noqa: E501

        :param access_type: The access_type of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def connection_timeout(self):
        """Gets the connection_timeout of this ContentV1Exp.  # noqa: E501
        ...
        :return: The connection_timeout of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def connection_timeout(self, connection_timeout):
        """Sets the connection_timeout of this ContentV1Exp.

        Maximum number of seconds allowed without data sent or received across a client connection. A value of `0` means connections will never time-out (not recommended). When `null`, the default `Scheduler.ConnectionTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param connection_timeout: The connection_timeout of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def read_timeout(self):
        """Gets the read_timeout of this ContentV1Exp.  # noqa: E501
        ...
        :return: The read_timeout of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def read_timeout(self, read_timeout):
        """Sets the read_timeout of this ContentV1Exp.

        Maximum number of seconds allowed without data received from a client connection. A value of `0` means a lack of client (browser) interaction never causes the connection to close. When `null`, the default `Scheduler.ReadTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param read_timeout: The read_timeout of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def init_timeout(self):
        """Gets the init_timeout of this ContentV1Exp.  # noqa: E501
        ...
        :return: The init_timeout of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def init_timeout(self, init_timeout):
        """Sets the init_timeout of this ContentV1Exp.

        The maximum number of seconds allowed for an interactive application to start. Posit Connect must be able to connect to a newly launched Shiny application, for example, before this threshold has elapsed. When `null`, the default `Scheduler.InitTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param init_timeout: The init_timeout of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def idle_timeout(self):
        """Gets the idle_timeout of this ContentV1Exp.  # noqa: E501
        ...
        :return: The idle_timeout of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def idle_timeout(self, idle_timeout):
        """Sets the idle_timeout of this ContentV1Exp.

        The maximum number of seconds a worker process for an interactive application to remain alive after it goes idle (no active connections). When `null`, the default `Scheduler.IdleTimeout` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param idle_timeout: The idle_timeout of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def max_processes(self):
        """Gets the max_processes of this ContentV1Exp.  # noqa: E501
        ...
        :return: The max_processes of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def max_processes(self, max_processes):
        """Sets the max_processes of this ContentV1Exp.

        Specifies the total number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MaxProcesses` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param max_processes: The max_processes of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def min_processes(self):
        """Gets the min_processes of this ContentV1Exp.  # noqa: E501
        ...
        :return: The min_processes of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def min_processes(self, min_processes):
        """Sets the min_processes of this ContentV1Exp.

        Specifies the minimum number of concurrent processes allowed for a single interactive application. When `null`, the default `Scheduler.MinProcesses` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param min_processes: The min_processes of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def max_conns_per_process(self):
        """Gets the max_conns_per_process of this ContentV1Exp.  # noqa: E501
        ...
        :return: The max_conns_per_process of this ContentV1Exp.  # noqa: E501
        :rtype: int
        """
    ...
    def max_conns_per_process(self, max_conns_per_process):
        """Sets the max_conns_per_process of this ContentV1Exp.

        Specifies the maximum number of client connections allowed to an individual process. Incoming connections which will exceed this limit are routed to a new process or rejected. When `null`, the default `Scheduler.MaxConnsPerProcess` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param max_conns_per_process: The max_conns_per_process of this ContentV1Exp.  # noqa: E501
        :type: int
        """
    ...
    def load_factor(self):
        """Gets the load_factor of this ContentV1Exp.  # noqa: E501
        ...
        :return: The load_factor of this ContentV1Exp.  # noqa: E501
        :rtype: float
        """
    ...
    def load_factor(self, load_factor):
        """Sets the load_factor of this ContentV1Exp.

        Controls how aggressively new processes are spawned. When `null`, the default `Scheduler.LoadFactor` is used. Applies only to content types that are executed on demand.  # noqa: E501

        :param load_factor: The load_factor of this ContentV1Exp.  # noqa: E501
        :type: float
        """
    ...
    def created_time(self):
        """Gets the created_time of this ContentV1Exp.  # noqa: E501

        The timestamp (RFC3339) indicating when this content was created.  # noqa: E501

        :return: The created_time of this ContentV1Exp.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this ContentV1Exp.

        The timestamp (RFC3339) indicating when this content was created.  # noqa: E501

        :param created_time: The created_time of this ContentV1Exp.  # noqa: E501
        :type: datetime
        """
    ...
    def last_deployed_time(self):
        """Gets the last_deployed_time of this ContentV1Exp.  # noqa: E501

        The timestamp (RFC3339) indicating when this content last had a successful bundle deployment performed.  # noqa: E501

        :return: The last_deployed_time of this ContentV1Exp.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_deployed_time(self, last_deployed_time):
        """Sets the last_deployed_time of this ContentV1Exp.

        The timestamp (RFC3339) indicating when this content last had a successful bundle deployment performed.  # noqa: E501

        :param last_deployed_time: The last_deployed_time of this ContentV1Exp.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def bundle_id(self):
        """Gets the bundle_id of this ContentV1Exp.  # noqa: E501
        ...
        :return: The bundle_id of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def bundle_id(self, bundle_id):
        """Sets the bundle_id of this ContentV1Exp.

        The identifier for the active deployment bundle. Automatically assigned upon the successful deployment of that bundle.  # noqa: E501

        :param bundle_id: The bundle_id of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def app_mode(self):
        """Gets the app_mode of this ContentV1Exp.  # noqa: E501
        ...
        :return: The app_mode of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def app_mode(self, app_mode):
        """Sets the app_mode of this ContentV1Exp.

        The runtime model for this content. Has a value of `unknown` before data is deployed to this item. Automatically assigned upon the first successful bundle deployment.  Valid values are:  * `api` - R code defining a [Plumber API](https://www.rplumber.io/). * `jupyter-static` - A [Jupyter Notebook](https://jupyter-notebook.readthedocs.io/en/stable/). * `python-api` - Python code defining a WSGI API (such as [Flask](https://palletsprojects.com/p/flask/)) * `python-bokeh` - Python code defining a [Bokeh application](https://bokeh.org/). * `python-dash` - Python code defining a [Dash application](https://dash.plotly.com/). * `python-fastapi` - Python code defining an ASGI API (such as [FastAPI](https://fastapi.tiangolo.com/)) * `python-streamlit` - Python code defining a [Streamlit application](https://streamlit.io/). * `python-shiny` - Python code defining a [Shiny application](https://shiny.rstudio.com/py/). * `quarto-shiny` - A [Quarto](https://quarto.org/) document with a Shiny runtime. * `quarto-static` - A [Quarto](https://quarto.org/) document or site. * `rmd-shiny` - An [R Markdown](https://rmarkdown.rstudio.com/) document with a Shiny runtime. * `rmd-static` - An [R Markdown](https://rmarkdown.rstudio.com/) document or site. * `shiny` - R code defining a [Shiny application](https://shiny.rstudio.com/). * `static` - Content deployed without source; often HTML and plots. * `tensorflow-saved-model` - A TensorFlow Model API (obsolete). * `unknown` - No known runtime model.  # noqa: E501

        :param app_mode: The app_mode of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def content_category(self):
        """Gets the content_category of this ContentV1Exp.  # noqa: E501
        ...
        :return: The content_category of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def content_category(self, content_category):
        """Sets the content_category of this ContentV1Exp.

        Describes the specialization of the content runtime model. Automatically assigned upon the first successful bundle deployment.  The `content_category` field refines the type of content specified by `app_mode`. It is empty by default. The rsconnect R package may assign a value when analyzing your content and building its manifest and bundle. Plots (images created in the RStudio IDE and presented in the \"Plots\" pane) have an `app_mode` of `static` and receive a `content_category` of `plot` to distinguish them from other HTML documents. Pinned static data sets have an `app_mode` of `static` and a `content_category` of `pin`. Multi-document R Markdown sites have an `app_mode` of `rmd-static` and a `content_category` of `site`.  # noqa: E501

        :param content_category: The content_category of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def has_parameters(self):
        """Gets the has_parameters of this ContentV1Exp.  # noqa: E501
        ...
        :return: The has_parameters of this ContentV1Exp.  # noqa: E501
        :rtype: bool
        """
    ...
    def has_parameters(self, has_parameters):
        """Sets the has_parameters of this ContentV1Exp.

        True when R Markdown rendered content allows parameter configuration. Automatically assigned upon the first successful bundle deployment. Applies only to content with an `app_mode` of `rmd-static`.  # noqa: E501

        :param has_parameters: The has_parameters of this ContentV1Exp.  # noqa: E501
        :type: bool
        """
    ...
    def cluster_name(self):
        """Gets the cluster_name of this ContentV1Exp.  # noqa: E501
        ...
        :return: The cluster_name of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def cluster_name(self, cluster_name):
        """Sets the cluster_name of this ContentV1Exp.

        The location where this content runs. Content running on the same server as Connect will have either a `null` value or the string \"Local\". Gives the name of the cluster when run external to the Connect host.  # noqa: E501

        :param cluster_name: The cluster_name of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def image_name(self):
        """Gets the image_name of this ContentV1Exp.  # noqa: E501

        The location where content this content runs. Content running on the same server as Connect will have either a `null` value or the string \"Local\". References the name of the target image when content runs in a clustered environment such as Kubernetes.  # noqa: E501

        :return: The image_name of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def image_name(self, image_name):
        """Sets the image_name of this ContentV1Exp.

        The location where content this content runs. Content running on the same server as Connect will have either a `null` value or the string \"Local\". References the name of the target image when content runs in a clustered environment such as Kubernetes.  # noqa: E501

        :param image_name: The image_name of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def r_version(self, r_version):
        """Sets the r_version of this ContentV1Exp.

        The version of the R interpreter associated with this content. The value `null` represents that an R interpreter is not used by this content or that the client does not have sufficient rights to see this information or that the R package environment has not been successfully restored. Automatically assigned upon the successful deployment of a bundle.  # noqa: E501

        :param r_version: The r_version of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def py_version(self):
        """Gets the py_version of this ContentV1Exp.  # noqa: E501
        ...
        :return: The py_version of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def py_version(self, py_version):
        """Sets the py_version of this ContentV1Exp.

        The version of the Python interpreter associated with this content. The value `null` represents that a Python interpreter is not used by this content or that the client does not have sufficient rights to see this information or that the Python package environment has not been successfully restored. Automatically assigned upon the successful deployment of a bundle.  # noqa: E501

        :param py_version: The py_version of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def quarto_version(self, quarto_version):
        """Sets the quarto_version of this ContentV1Exp.

        The version of Quarto associated with this content. The value `null` represents that Quarto is not used by this content or that the client does not have sufficient rights to see this information or that the content has not been successfully prepared for execution. Automatically assigned upon the successful deployment of a bundle.  # noqa: E501

        :param quarto_version: The quarto_version of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def run_as(self):
        """Gets the run_as of this ContentV1Exp.  # noqa: E501

        The UNIX user that executes this content. When `null`, the default `Applications.RunAs` is used. Applies only to executable content types - not `static`.  # noqa: E501

        :return: The run_as of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
        return self._run_as
    ...
    def run_as(self, run_as):
        """Sets the run_as of this ContentV1Exp.

        The UNIX user that executes this content. When `null`, the default `Applications.RunAs` is used. Applies only to executable content types - not `static`.  # noqa: E501

        :param run_as: The run_as of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def run_as_current_user(self, run_as_current_user):
        """Sets the run_as_current_user of this ContentV1Exp.

        Indicates that Connect should run processes for this content item under the Unix account of the user who visits it. Content accessed anonymously will continue to run as the specified `run_as` user.  Connect must be configured to use PAM authentication with the server settings `Applications.RunAsCurrentUser = true` and `PAM.ForwardPassword = true`. This setting has no effect for other authentication types.  This setting only applies to application content types (Shiny, Dash, Streamlit, and Bokeh).  # noqa: E501

        :param run_as_current_user: The run_as_current_user of this ContentV1Exp.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def owner_guid(self):
        """Gets the owner_guid of this ContentV1Exp.  # noqa: E501
        ...
        :return: The owner_guid of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def owner_guid(self, owner_guid):
        """Sets the owner_guid of this ContentV1Exp.

        The unique identifier of the user who created this content item. Automatically assigned when the content is created.  # noqa: E501

        :param owner_guid: The owner_guid of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this ContentV1Exp.  # noqa: E501

        The URL associated with this content. Computed from the associated vanity URL or the identifiers for this content.  # noqa: E501

        :return: The url of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ContentV1Exp.

        The URL associated with this content. Computed from the associated vanity URL or the identifiers for this content.  # noqa: E501

        :param url: The url of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def role(self):
        """Gets the role of this ContentV1Exp.  # noqa: E501
        ...
        :return: The role of this ContentV1Exp.  # noqa: E501
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        """Sets the role of this ContentV1Exp.

        The relationship of the accessing user to this content. A value of `owner` is returned for the content owner. `editor` indicates a collaborator. The `viewer` value is given to users who are permitted to view the content. A `none` role is returned for administrators who cannot view the content but are permitted to view its configuration. Computed at the time of the request.  # noqa: E501

        :param role: The role of this ContentV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContentV1Exp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentV1Exp):
            return False
