...
class TagsApi(object):
    ...
    def add_tag(self, body, guid, **kwargs):  # noqa: E501
        """Add tag to content  # noqa: E501

        Add the specified tag to an individual content item. When adding a tag, all tags above the specified tag in the tag tree are also added to the content item.  Authenticated access required from an admin or from a user with collaborator/editor permissions on the content item.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_tag(body, guid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GuidTagsBody body: The request body specifies which tag to add (required)
        :param str guid: The unique identifier of the content item. (required)
        :return: list[Tag]
        ...
        if kwargs.get('async_req'):
            return self.add_tag_with_http_info(body, guid, **kwargs)  # noqa: E501
        else:
            (data) = self.add_tag_with_http_info(body, guid, **kwargs)  # noqa: E501
            return data

    def add_tag_with_http_info(self, body, guid, **kwargs):  # noqa: E501
        """Add tag to content  # noqa: E501

        Add the specified tag to an individual content item. When adding a tag, all tags above the specified tag in the tag tree are also added to the content item.  Authenticated access required from an admin or from a user with collaborator/editor permissions on the content item.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_tag_with_http_info(body, guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `add_tag`")  # noqa: E501
    ...
    def create_tag(self, body, **kwargs):  # noqa: E501
        ...
        Create a new tag. Tags without a parent are considered tag \"categories\" and are used to organize other tags. Note that tag categories cannot be added to content items.  Authenticated access from a user having an \"administrator\" role is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param V1TagsBody body: The request body required when creating a new tag. (required)
        :return: Tag
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_tag(self, id, **kwargs):  # noqa: E501
        ...
        Deletes a tag, including all descendants in its own tag hierarchy.  Authenticated access from a user having an \"administrator\" role is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: The unique identifier of the tag. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_tag(self, id, **kwargs):  # noqa: E501
        ...
        Get an individual tag  Authenticated access from a user is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_tag_by_path(self, path, **kwargs):  # noqa: E501
        """Get tag by path  # noqa: E501

        Get an individual tag by a comma-delimited \"path\" to the tag. The path to the tag is the series of tag names to traverse the tag hierarchy, starting with a tag category.  Authenticated access from a user is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tag_by_path(path, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str path: The path to the tag, as comma-delimited names (required)
        :return: Tag
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tag_by_path_with_http_info(path, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tag_by_path_with_http_info(path, **kwargs)  # noqa: E501
            return data

    def get_tag_by_path_with_http_info(self, path, **kwargs):  # noqa: E501
        """Get tag by path  # noqa: E501

        Get an individual tag by a comma-delimited \"path\" to the tag. The path to the tag is the series of tag names to traverse the tag hierarchy, starting with a tag category.  Authenticated access from a user is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tag_by_path_with_http_info(path, async_req=True)
        >>> result = thread.get()
        ...
        if ('path' not in params or
                params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `get_tag_by_path`")  # noqa: E501
    ...
    def list_content_tags(self, guid, **kwargs):  # noqa: E501
        """List tags for content  # noqa: E501

        List of all tags for the specified content item  Authenticated access required from an admin or from a user with at least viewer permissions on the content item.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_content_tags(guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_content_tags_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.list_content_tags_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def list_content_tags_with_http_info(self, guid, **kwargs):  # noqa: E501
        """List tags for content  # noqa: E501

        List of all tags for the specified content item  Authenticated access required from an admin or from a user with at least viewer permissions on the content item.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_content_tags_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_content_tags" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'guid' is set
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `list_content_tags`")  # noqa: E501
    ...
    def list_tag_content(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_tag_content_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_tag_content_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def list_tag_content_with_http_info(self, id, **kwargs):  # noqa: E501
        """List content for tags  # noqa: E501

        List all of the content for the specified tag.  Authenticated access from a user is required. If an \"administrator\" role is used, then all content items will be returned regardless of the visibility to the requesting user.  Note that R or Python version information is only provided to clients that authenticate as admin or publisher users; it is suppressed for viewers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_tag_content_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_tag_content" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `list_tag_content`")  # noqa: E501
    ...
    def list_tags(self, **kwargs):  # noqa: E501
        ...
        List of all tags.  Authenticated access from a user is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str parent_id: The unique identifier of the parent tag
        :param str name: The tag name  Note: tag names are only unique within the scope of a parent, which means that it is possible to have multiple results when querying by name; however, querying by both `name` and `parent_id` ensures a single result.
        :return: list[Tag]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['parent_id', 'name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def remove_tag(self, guid, id, **kwargs):  # noqa: E501
        """Remove tag from content  # noqa: E501

        Remove the specified tag from an individual content item. When removing a tag, all children and descendant tags are also removed from the content item.  Authenticated access required from an admin or from a user with collaborator/editor permissions on the content item.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_tag(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_tag_with_http_info(guid, id, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_tag_with_http_info(guid, id, **kwargs)  # noqa: E501
            return data

    def remove_tag_with_http_info(self, guid, id, **kwargs):  # noqa: E501
        """Remove tag from content  # noqa: E501

        Remove the specified tag from an individual content item. When removing a tag, all children and descendant tags are also removed from the content item.  Authenticated access required from an admin or from a user with collaborator/editor permissions on the content item.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_tag_with_http_info(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `remove_tag`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
        ...
        return self.api_client.call_api(
            '/v1/content/{guid}/tags/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_tag(self, body, id, **kwargs):  # noqa: E501
        ...
        Update an existing tag.  Authenticated access from a user having an \"administrator\" role is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param TagsIdBody body: The request body required when updating an existing tag. (required)
        :param str id: The unique identifier of the tag. (required)
        :return: Tag
                 If the method is called asynchronously,
                 returns the request thread.
