...
#' \item \emph{ @returnType } \link{JobItem} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The content job.
#'
#' \item return type : JobItem
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @returnType } list( \link{JobItem} ) \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | An array of content jobs.
#'
#' \item return type : array[JobItem]
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ JobDownloadLog } \emph{ Download job log file }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The log file of the job containing both stdout and stderr
#'
...
#' }
#'
#' \strong{ JobError } \emph{ Get job error }
...
#' \item \emph{ @param } guid character
#' \item \emph{ @param } key character
#' \item \emph{ @returnType } \link{LoggedError} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The primary error of a job.
#'
#' \item return type : LoggedError
#' \item response headers :
#'
#' \tabular{ll}{
#' }
#' \item status code : 204 | No error is found.
#'
#'
#' \item response headers :
#'
...
#' }
#'
#' \strong{ JobLogs } \emph{ Get job log }
...
#' \item \emph{ @param } guid character
#' \item \emph{ @param } key character
#' \item \emph{ @param } max_log_lines integer
#' \item \emph{ @returnType } \link{LogEntries} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The log output for the job
#'
#' \item return type : LogEntries
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ JobTailLog } \emph{ Tail job log }
...
#' \item \emph{ @param } guid character
#' \item \emph{ @param } key character
#' \item \emph{ @returnType } \link{LogEntry} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | An open connection actively sending job log entries as they are created. Closes when job is finalized.
#'
#' \item return type : LogEntry
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ KillJob } \emph{ Register job kill order }
...
#' \item \emph{ @param } guid character
#' \item \emph{ @param } key character
#' \item \emph{ @returnType } \link{KillJobOrder} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The order to kill the job was properly registered.
#'
#' \item return type : KillJobOrder
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
JobsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param key The job's unique key
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return JobItem
    #' @export
    GetJob = function(guid, key, data_file = NULL, ...) {
      local_var_response <- self$GetJobWithHttpInfo(guid, key, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (JobItem) with additional information such as HTTP status code, headers
    #' @export
    GetJobWithHttpInfo = function(guid, key, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`key`)) {
        rlang::abort(message = "Missing required parameter `key`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
      ...
      local_var_url_path <- "/v1/content/{guid}/jobs/{key}"
      if (!missing(`guid`)) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "JobItem", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' @export
    GetJobs = function(guid, data_file = NULL, ...) {
      local_var_response <- self$GetJobsWithHttpInfo(guid, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[JobItem]) with additional information such as HTTP status code, headers
    #' @export
    GetJobsWithHttpInfo = function(guid, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/jobs"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[JobItem]", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @param guid The unique identifier of the desired content item
    #' @param key The job's unique key
    #' @param filename (optional) The name of the file to retrieve (default value: "rstudio-connect.{app_id}.{variant_id}.{bundle_id}.{job_tag}.{job_key}.log")
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return data.frame
    #' @export
    JobDownloadLog = function(guid, key, filename = "rstudio-connect.{app_id}.{variant_id}.{bundle_id}.{job_tag}.{job_key}.log", data_file = NULL, ...) {
      local_var_response <- self$JobDownloadLogWithHttpInfo(guid, key, filename, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    JobDownloadLogWithHttpInfo = function(guid, key, filename = "rstudio-connect.{app_id}.{variant_id}.{bundle_id}.{job_tag}.{job_key}.log", data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/jobs/{key}/download"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "data.frame", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return LoggedError
    #' @export
    JobError = function(guid, key, data_file = NULL, ...) {
      local_var_response <- self$JobErrorWithHttpInfo(guid, key, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (LoggedError) with additional information such as HTTP status code, headers
    #' @export
    JobErrorWithHttpInfo = function(guid, key, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/jobs/{key}/error"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "LoggedError", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @param guid The unique identifier of the desired content item
    #' @param key The job's unique key
    #' @param max_log_lines (optional) The maximum number of log lines to return (default value: 5000)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return LogEntries
    #' @export
    JobLogs = function(guid, key, max_log_lines = 5000, data_file = NULL, ...) {
      local_var_response <- self$JobLogsWithHttpInfo(guid, key, max_log_lines, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (LogEntries) with additional information such as HTTP status code, headers
    #' @export
    JobLogsWithHttpInfo = function(guid, key, max_log_lines = 5000, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      query_params[["maxLogLines"]] <- `max_log_lines`

      local_var_url_path <- "/v1/content/{guid}/jobs/{key}/log"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "LogEntries", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return LogEntry
    #' @export
    JobTailLog = function(guid, key, data_file = NULL, ...) {
      local_var_response <- self$JobTailLogWithHttpInfo(guid, key, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (LogEntry) with additional information such as HTTP status code, headers
    #' @export
    JobTailLogWithHttpInfo = function(guid, key, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/content/{guid}/jobs/{key}/tail"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "LogEntry", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #' @return KillJobOrder
    #' @export
    KillJob = function(guid, key, data_file = NULL, ...) {
      local_var_response <- self$KillJobWithHttpInfo(guid, key, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (KillJobOrder) with additional information such as HTTP status code, headers
    #' @export
    KillJobWithHttpInfo = function(guid, key, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "KillJobOrder", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
