...
class BundlesApi(object):
    ...
    def delete_bundle(self, guid, id, **kwargs):  # noqa: E501
        """Delete bundle  # noqa: E501

        Delete a specific bundle.  Bundle deletion is permitted by authorized clients with collaborator rights.  On-disk data and database records are removed as a consequence of this call. Deletion is not allowed while the bundle is still active.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_bundle(guid, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str guid: The unique identifier of the desired content item. (required)
        :param str id: The unique identifier of the desired bundle. (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.delete_bundle_with_http_info(guid, id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_bundle_with_http_info(guid, id, **kwargs)  # noqa: E501
            return data

    def delete_bundle_with_http_info(self, guid, id, **kwargs):  # noqa: E501
        """Delete bundle  # noqa: E501

        Delete a specific bundle.  Bundle deletion is permitted by authorized clients with collaborator rights.  On-disk data and database records are removed as a consequence of this call. Deletion is not allowed while the bundle is still active.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_bundle_with_http_info(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `delete_bundle`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_bundle`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/content/{guid}/bundles/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def download_bundle(self, guid, id, **kwargs):  # noqa: E501
        """Download the bundle archive  # noqa: E501

        Download a deployment bundle.  Bundle download is permitted by authorized clients with collaborator rights.  Download a `gzip` compressed `tar` archive (`.tar.gz`) containing the code/data from one deployment of the associated content.  See the  <a href=\"#post-/v1/content/-guid-/bundles\">POST /v1/content/{guid}/bundles</a> endpoint for details about the construction of bundle archives.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_bundle(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.download_bundle_with_http_info(guid, id, **kwargs)  # noqa: E501
        else:
            (data) = self.download_bundle_with_http_info(guid, id, **kwargs)  # noqa: E501
            return data

    def download_bundle_with_http_info(self, guid, id, **kwargs):  # noqa: E501
        """Download the bundle archive  # noqa: E501

        Download a deployment bundle.  Bundle download is permitted by authorized clients with collaborator rights.  Download a `gzip` compressed `tar` archive (`.tar.gz`) containing the code/data from one deployment of the associated content.  See the  <a href=\"#post-/v1/content/-guid-/bundles\">POST /v1/content/{guid}/bundles</a> endpoint for details about the construction of bundle archives.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_bundle_with_http_info(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `download_bundle`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `download_bundle`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/content/{guid}/bundles/{id}/download', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_bundle(self, guid, id, **kwargs):  # noqa: E501
        """Get bundle details  # noqa: E501

        Get detailed information about a specific bundle.  Bundle reads are permitted by all users with viewership rights to the content item. Information about the target environment is populated for users with \"publisher\" and \"administrator\" role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bundle(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_bundle_with_http_info(guid, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_bundle_with_http_info(guid, id, **kwargs)  # noqa: E501
            return data

    def get_bundle_with_http_info(self, guid, id, **kwargs):  # noqa: E501
        """Get bundle details  # noqa: E501

        Get detailed information about a specific bundle.  Bundle reads are permitted by all users with viewership rights to the content item. Information about the target environment is populated for users with \"publisher\" and \"administrator\" role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bundle_with_http_info(guid, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `get_bundle`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_bundle`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/content/{guid}/bundles/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_bundles(self, guid, **kwargs):  # noqa: E501
        """List bundles  # noqa: E501

        List bundles associated with a specific content item.  Bundle enumeration is permitted by all users with viewership rights to the content item. Information about the target environment is populated for users with \"publisher\" and \"administrator\" role.  Results are sorted by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bundles(guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_bundles_with_http_info(guid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_bundles_with_http_info(guid, **kwargs)  # noqa: E501
            return data

    def get_bundles_with_http_info(self, guid, **kwargs):  # noqa: E501
        """List bundles  # noqa: E501

        List bundles associated with a specific content item.  Bundle enumeration is permitted by all users with viewership rights to the content item. Information about the target environment is populated for users with \"publisher\" and \"administrator\" role.  Results are sorted by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bundles_with_http_info(guid, async_req=True)
        >>> result = thread.get()
        ...
        if ('guid' not in params or
                params['guid'] is None):
            raise ValueError("Missing the required parameter `guid` when calling `get_bundles`")  # noqa: E501
    ...
    def upload_content_bundle(self, body, guid, **kwargs):  # noqa: E501
        """Create a bundle by uploading an archive  # noqa: E501
