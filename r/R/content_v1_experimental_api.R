...
#'
#' @docType class
#' @title ContentV1Experimental operations
#' @description ContentV1ExperimentalApi
...
#'
#' \itemize{
#' \item \emph{ @param } content \link{CreateContentRequest1}
#' \item \emph{ @returnType } \link{ContentV1Exp} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The details for the newly created content.
#'
#' \item return type : ContentV1Exp
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } instructions \link{DeployContentBundleRequest1}
#' \item \emph{ @returnType } \link{DeployContentBundle200Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested content details.
#'
#' \item return type : DeployContentBundle200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } content \link{UpdateContentRequest1}
#' \item \emph{ @returnType } \link{ContentV1Exp} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#' }
#'
#' \strong{ UploadContentBundle } \emph{ Upload deployment bundle }
...
#' \itemize{
#' \item \emph{ @param } guid character
#' \item \emph{ @param } archive data.frame
#' \item \emph{ @param } x_content_checksum character
#' \item \emph{ @returnType } \link{UploadContentBundle200Response} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The requested content details.
#'
#' \item return type : UploadContentBundle200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' @export
ContentV1ExperimentalApi <- R6::R6Class(
  "ContentV1ExperimentalApi",
  public = list(
    api_client = NULL,
    #' Initialize a new ContentV1ExperimentalApi.
    #'
    #' @description
    #' Initialize a new ContentV1ExperimentalApi.
    #'
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (ContentV1Exp) with additional information such as HTTP status code, headers
    #' @export
    CreateContentWithHttpInfo = function(content, data_file = NULL, ...) {
      ...
      local_var_url_path <- "/v1/experimental/content"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "ContentV1Exp", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    DeleteContentWithHttpInfo = function(guid, ...) {
      ...
      local_var_url_path <- "/v1/experimental/content/{guid}"
      if (!missing(`guid`)) {
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (DeployContentBundle200Response) with additional information such as HTTP status code, headers
    #' @export
    DeployContentBundleWithHttpInfo = function(guid, instructions = NULL, data_file = NULL, ...) {
      ...
      local_var_url_path <- "/v1/experimental/content/{guid}/deploy"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "DeployContentBundle200Response", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
    ...
    #'
    #' @param guid The unique identifier of the desired content item.
    #' @param archive A `gzip` compressed `tar` archive file.
    #' @param x_content_checksum (optional) The Base64-encoded MD5 sum of the archive file.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return UploadContentBundle200Response
    #' @export
    UploadContentBundle = function(guid, archive, x_content_checksum = NULL, data_file = NULL, ...) {
      local_var_response <- self$UploadContentBundleWithHttpInfo(guid, archive, x_content_checksum, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (UploadContentBundle200Response) with additional information such as HTTP status code, headers
    #' @export
    UploadContentBundleWithHttpInfo = function(guid, archive, x_content_checksum = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`archive`)) {
        rlang::abort(message = "Missing required parameter `archive`.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Missing required parameter `archive`."))
      }




      header_params["X-Content-Checksum"] <- `x_content_checksum`

      if (!is.null(`archive`)) {
        local_var_body <- `archive`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/v1/experimental/content/{guid}/upload"
      if (!missing(`guid`)) {
        local_var_url_path <- gsub("\\{guid\\}", URLencode(as.character(`guid`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "UploadContentBundle200Response", loadNamespace("connectapi2")),
          error = function(e) {
            rlang::abort(message = "Failed to deserialize response",
                         .subclass = "ApiException",
                         ApiException = ApiException$new(http_response = local_var_resp))
