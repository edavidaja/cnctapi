...
class BundleV1Exp(object):
    ...
    def __init__(self, id=None, content_guid=None, created_time=None, cluster_name=None, image_name=None, r_version=None, py_version=None, quarto_version=None, active=None, size=None):  # noqa: E501
        """BundleV1Exp - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this BundleV1Exp.  # noqa: E501

        The identifier for this bundle.  # noqa: E501

        :return: The id of this BundleV1Exp.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this BundleV1Exp.

        The identifier for this bundle.  # noqa: E501

        :param id: The id of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def content_guid(self):
        """Gets the content_guid of this BundleV1Exp.  # noqa: E501

        The identifier of the owning content.  # noqa: E501

        :return: The content_guid of this BundleV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def content_guid(self, content_guid):
        """Sets the content_guid of this BundleV1Exp.

        The identifier of the owning content.  # noqa: E501

        :param content_guid: The content_guid of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def created_time(self):
        """Gets the created_time of this BundleV1Exp.  # noqa: E501

        The timestamp (RFC3339) of when this bundle was created.  # noqa: E501

        :return: The created_time of this BundleV1Exp.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this BundleV1Exp.

        The timestamp (RFC3339) of when this bundle was created.  # noqa: E501

        :param created_time: The created_time of this BundleV1Exp.  # noqa: E501
        :type: datetime
        """
    ...
    def cluster_name(self, cluster_name):
        """Sets the cluster_name of this BundleV1Exp.

        The location where this content bundle runs. Content running on the same server as Connect will have either a `null` value or the string \"Local\". Gives the name of the cluster when run external to the Connect host.  Cluster name is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :param cluster_name: The cluster_name of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def image_name(self):
        """Gets the image_name of this BundleV1Exp.  # noqa: E501
        ...
        :return: The image_name of this BundleV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def image_name(self, image_name):
        """Sets the image_name of this BundleV1Exp.

        The location where content this content bundle runs. Content running on the same server as Connect will have either a `null` value or the string \"Local\". References the name of the target image when content runs in a clustered environment such as Kubernetes.  Image name is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :param image_name: The image_name of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def r_version(self, r_version):
        """Sets the r_version of this BundleV1Exp.

        The version of the R interpreter used when last restoring this bundle. The value `null` represents that an R interpreter is not used by this bundle or that the R package environment has not been successfully restored.  R version is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :param r_version: The r_version of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def py_version(self):
        """Gets the py_version of this BundleV1Exp.  # noqa: E501

        The version of the Python interpreter used when last restoring this bundle.  The value `null` represents that a Python interpreter is not used by this bundle or that the Python package environment has not been successfully restored.  Python version is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :return: The py_version of this BundleV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def py_version(self, py_version):
        """Sets the py_version of this BundleV1Exp.

        The version of the Python interpreter used when last restoring this bundle.  The value `null` represents that a Python interpreter is not used by this bundle or that the Python package environment has not been successfully restored.  Python version is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :param py_version: The py_version of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    def quarto_version(self):
        """Gets the quarto_version of this BundleV1Exp.  # noqa: E501

        The version of the Quarto interpreter used when last restoring this bundle. The value `null` represents that Quarto is not used by this bundle or that the bundle has not been successfully prepared for execution.  Quarto version is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :return: The quarto_version of this BundleV1Exp.  # noqa: E501
        :rtype: str
        """
    ...
    def quarto_version(self, quarto_version):
        """Sets the quarto_version of this BundleV1Exp.

        The version of the Quarto interpreter used when last restoring this bundle. The value `null` represents that Quarto is not used by this bundle or that the bundle has not been successfully prepared for execution.  Quarto version is not disclosed to users with a \"viewer\" role and returned with the value `null`.  # noqa: E501

        :param quarto_version: The quarto_version of this BundleV1Exp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def active(self):
        """Gets the active of this BundleV1Exp.  # noqa: E501

        Indicates if this bundle is active for the owning content.  # noqa: E501

        :return: The active of this BundleV1Exp.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this BundleV1Exp.

        Indicates if this bundle is active for the owning content.  # noqa: E501

        :param active: The active of this BundleV1Exp.  # noqa: E501
        :type: bool
        """
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this BundleV1Exp.

        On-disk size in bytes of the tar.gz file associated with this bundle. Zero when there is no on-disk file.  # noqa: E501

        :param size: The size of this BundleV1Exp.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BundleV1Exp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BundleV1Exp):
            return False
