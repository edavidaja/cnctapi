...
class ContentVisit(object):
    ...
    def __init__(self, content_guid=None, user_guid=None, variant_key=None, rendering_id=None, bundle_id=None, time=None, data_version=None):  # noqa: E501
        """ContentVisit - a model defined in Swagger"""  # noqa: E501
        self._content_guid = None
        self._user_guid = None
        self._variant_key = None
        self._rendering_id = None
    ...
    def content_guid(self):
        """Gets the content_guid of this ContentVisit.  # noqa: E501

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the content this information pertains to.  # noqa: E501

        :return: The content_guid of this ContentVisit.  # noqa: E501
        :rtype: str
        """
    ...
    def content_guid(self, content_guid):
        """Sets the content_guid of this ContentVisit.

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the content this information pertains to.  # noqa: E501

        :param content_guid: The content_guid of this ContentVisit.  # noqa: E501
        :type: str
        """
        if content_guid is None:
            raise ValueError("Invalid value for `content_guid`, must not be `None`")  # noqa: E501

        self._content_guid = content_guid

    @property
    def user_guid(self):
        """Gets the user_guid of this ContentVisit.  # noqa: E501

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the user that visited the content.  # noqa: E501

        :return: The user_guid of this ContentVisit.  # noqa: E501
        :rtype: str
        """
    ...
    def user_guid(self, user_guid):
        """Sets the user_guid of this ContentVisit.

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the user that visited the content.  # noqa: E501

        :param user_guid: The user_guid of this ContentVisit.  # noqa: E501
        :type: str
        """
        if user_guid is None:
            raise ValueError("Invalid value for `user_guid`, must not be `None`")  # noqa: E501

        self._user_guid = user_guid

    @property
    def variant_key(self):
        """Gets the variant_key of this ContentVisit.  # noqa: E501

        The key of the variant the user visited.  This will be `null` for static content.  # noqa: E501

        :return: The variant_key of this ContentVisit.  # noqa: E501
        :rtype: str
        """
    ...
    def variant_key(self, variant_key):
        """Sets the variant_key of this ContentVisit.

        The key of the variant the user visited.  This will be `null` for static content.  # noqa: E501

        :param variant_key: The variant_key of this ContentVisit.  # noqa: E501
        :type: str
        """
    ...
    def rendering_id(self):
        """Gets the rendering_id of this ContentVisit.  # noqa: E501

        The ID of the rendering the user visited.  This will be `null` for static content.  # noqa: E501

        :return: The rendering_id of this ContentVisit.  # noqa: E501
        :rtype: int
        """
    ...
    def rendering_id(self, rendering_id):
        """Sets the rendering_id of this ContentVisit.

        The ID of the rendering the user visited.  This will be `null` for static content.  # noqa: E501

        :param rendering_id: The rendering_id of this ContentVisit.  # noqa: E501
        :type: int
        """
    ...
    @property
    def bundle_id(self):
        """Gets the bundle_id of this ContentVisit.  # noqa: E501

        The ID of the particular bundle used.  # noqa: E501

        :return: The bundle_id of this ContentVisit.  # noqa: E501
        :rtype: int
        """
    ...
    def bundle_id(self, bundle_id):
        """Sets the bundle_id of this ContentVisit.

        The ID of the particular bundle used.  # noqa: E501

        :param bundle_id: The bundle_id of this ContentVisit.  # noqa: E501
        :type: int
        """
    ...
    @property
    def time(self):
        """Gets the time of this ContentVisit.  # noqa: E501

        The timestamp, in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format, when the user visited the content.  # noqa: E501

        :return: The time of this ContentVisit.  # noqa: E501
        :rtype: datetime
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this ContentVisit.

        The timestamp, in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format, when the user visited the content.  # noqa: E501

        :param time: The time of this ContentVisit.  # noqa: E501
        :type: datetime
        """
        if time is None:
    ...
    def data_version(self):
        """Gets the data_version of this ContentVisit.  # noqa: E501

        The data version the record was recorded with.  The [Content Visit Events](../admin/historical-information/#content-visit-events) section of the Posit Connect Admin Guide explains how to interpret `data_version` values.  # noqa: E501

        :return: The data_version of this ContentVisit.  # noqa: E501
        :rtype: int
        """
    ...
    def data_version(self, data_version):
        """Sets the data_version of this ContentVisit.

        The data version the record was recorded with.  The [Content Visit Events](../admin/historical-information/#content-visit-events) section of the Posit Connect Admin Guide explains how to interpret `data_version` values.  # noqa: E501

        :param data_version: The data_version of this ContentVisit.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContentVisit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentVisit):
            return False
