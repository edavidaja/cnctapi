#' Create a new UpdateContentRequest1
#'
#' @description
#' The Content fields that can be specified when creating or updating a content item.
#'
#' @docType class
#' @title UpdateContentRequest1
#' @description UpdateContentRequest1 Class
...
#' @export
UpdateContentRequest1 <- R6::R6Class(
  "UpdateContentRequest1",
  public = list(
    `name` = NULL,
    `title` = NULL,
    `description` = NULL,
    ...
    `load_factor` = NULL,
    #' Initialize a new UpdateContentRequest1 class.
    #'
    #' @description
    #' Initialize a new UpdateContentRequest1 class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UpdateContentRequest1 in JSON format
    #' @export
    toJSON = function() {
      UpdateContentRequest1Object <- list()
      if (!is.null(self$`name`)) {
        UpdateContentRequest1Object[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`title`)) {
        UpdateContentRequest1Object[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`description`)) {
        UpdateContentRequest1Object[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`access_type`)) {
        UpdateContentRequest1Object[["access_type"]] <-
          self$`access_type`
      }
      if (!is.null(self$`connection_timeout`)) {
        UpdateContentRequest1Object[["connection_timeout"]] <-
          self$`connection_timeout`
      }
      if (!is.null(self$`read_timeout`)) {
        UpdateContentRequest1Object[["read_timeout"]] <-
          self$`read_timeout`
      }
      if (!is.null(self$`init_timeout`)) {
        UpdateContentRequest1Object[["init_timeout"]] <-
          self$`init_timeout`
      }
      if (!is.null(self$`idle_timeout`)) {
        UpdateContentRequest1Object[["idle_timeout"]] <-
          self$`idle_timeout`
      }
      if (!is.null(self$`max_processes`)) {
        UpdateContentRequest1Object[["max_processes"]] <-
          self$`max_processes`
      }
      if (!is.null(self$`min_processes`)) {
        UpdateContentRequest1Object[["min_processes"]] <-
          self$`min_processes`
      }
      if (!is.null(self$`max_conns_per_process`)) {
        UpdateContentRequest1Object[["max_conns_per_process"]] <-
          self$`max_conns_per_process`
      }
      if (!is.null(self$`load_factor`)) {
        UpdateContentRequest1Object[["load_factor"]] <-
          self$`load_factor`
      }
      UpdateContentRequest1Object
    },
    #' Deserialize JSON string into an instance of UpdateContentRequest1
    #'
    #' @description
    #' Deserialize JSON string into an instance of UpdateContentRequest1
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdateContentRequest1
    #' @export
    ...
    #' Validate JSON input with respect to UpdateContentRequest1
    #'
    #' @description
    #' Validate JSON input with respect to UpdateContentRequest1 and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdateContentRequest1: the required field `name` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UpdateContentRequest1
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UpdateContentRequest1$unlock()
#
## Below is an example to define the print function
# UpdateContentRequest1$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UpdateContentRequest1$lock()
