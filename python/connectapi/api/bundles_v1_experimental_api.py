...
class BundlesV1ExperimentalApi(object):
    ...
    def delete_bundle(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_bundle(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_bundle_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_bundle_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_bundle_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete bundle  # noqa: E501

        Delete a specific bundle.  Bundle deletion is permitted by authorized clients with collaborator rights.  On-disk data and database records are removed as a consequence of this call. Deletion is not allowed while the bundle is still active.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_bundle_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/v1/experimental/bundles/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def download_bundle(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.download_bundle_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.download_bundle_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def download_bundle_with_http_info(self, id, **kwargs):  # noqa: E501
        """Download the bundle archive  # noqa: E501

        Download a deployment bundle.  Bundle download is permitted by authorized clients with collaborator rights.  Download a `gzip` compressed `tar` archive (`.tar.gz`) containing the code/data from one deployment of the associated content.  See the  <a href=\"#post-/v1/experimental/content/-guid-/upload\">POST /v1/experimental/content/{guid}/upload</a> endpoint for details about the construction of bundle archives.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_bundle_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/v1/experimental/bundles/{id}/download', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_bundle(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bundle(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_bundle_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_bundle_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_bundle_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get bundle details  # noqa: E501

        Get detailed information about a specific bundle.  Bundle reads are permitted by all users with viewership rights to the content item. Information about the target environment is populated for users with \"publisher\" and \"administrator\" role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bundle_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/v1/experimental/bundles/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='BundleV1Exp',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_bundles(self, guid, **kwargs):  # noqa: E501
        ...
        :param int page_size: The number of items to include in each page. This parameter is \"best effort\" since there may not be enough bundles to honor the request. If `page_size` is less than 1 or greater than 500, an error will be returned.
        :return: BundlesV1Exp
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_bundles_with_http_info(self, guid, **kwargs):  # noqa: E501
        ...
        all_params = ['guid', 'page_number', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/v1/experimental/content/{guid}/bundles', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='BundlesV1Exp',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
