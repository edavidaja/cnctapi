...
#'
#' @docType class
#' @title BootstrapV1Experimental operations
#' @description BootstrapV1ExperimentalApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ Bootstrap } \emph{ Create first admininistrator and API key }
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link{BootstrapSuccess} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The API key for the initial administrator account.
#'
#' \item return type : BootstrapSuccess
...
#' @export
BootstrapV1ExperimentalApi <- R6::R6Class(
  "BootstrapV1ExperimentalApi",
  public = list(
    api_client = NULL,
    #' Initialize a new BootstrapV1ExperimentalApi.
    #'
    #' @description
    #' Initialize a new BootstrapV1ExperimentalApi.
    #'
    ...
    #' @export
    Bootstrap = function(data_file = NULL, ...) {
      local_var_response <- self$BootstrapWithHttpInfo(data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (BootstrapSuccess) with additional information such as HTTP status code, headers
    #' @export
    BootstrapWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/v1/experimental/bootstrap"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "BootstrapSuccess", loadNamespace("connectapi2")),
          error = function(e) {
