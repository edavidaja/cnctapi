...
#'
#' @docType class
#' @title Instrumentation operations
#' @description InstrumentationApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ GetContentVisits } \emph{ Get Content Visits }
...
#'
#' \itemize{
#' \item \emph{ @param } content_guid character
#' \item \emph{ @param } min_data_version integer
#' \item \emph{ @param } from character
#' \item \emph{ @param } to character
#' \item \emph{ @param } limit integer
#' \item \emph{ @param } previous character
#' \item \emph{ @param } var_next character
#' \item \emph{ @param } asc_order character
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The content visit results and paging information
#'
...
#' }
#'
#' \strong{ GetShinyAppUsage } \emph{ Get Shiny App Usage }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | The Shiny application usage results and paging information
#'
#' \item return type : object
#' \item response headers :
#'
...
#' @export
InstrumentationApi <- R6::R6Class(
  "InstrumentationApi",
  public = list(
    api_client = NULL,
    #' Initialize a new InstrumentationApi.
    #'
    #' @description
    #' Initialize a new InstrumentationApi.
    #'
    ...
    #' Get Content Visits
    #'
    #' @param content_guid (optional) Filter results by content GUID.  This parameter will limit the results to include only the access records for content matching the content GUID filter value.  Example value = `6f300623-1e0c-48e6-a473-ddf630c0c0c3` using UUID [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format.  Multiple content GUIDs may be specified using the bar character `|` which represents a logical OR across the surounding GUIDs.  For example, `content_guid=6f300623-1e0c-48e6-a473-ddf630c0c0c3|e08a86af-a262-4152-8366-f2d8ec3c54f9` will filter the result set to only the access records for content with a GUID of `6f300623-1e0c-48e6-a473-ddf630c0c0c3` or a GUID of `e08a86af-a262-4152-8366-f2d8ec3c54f9`.  - The GUID associated with published content can be found on the Info panel for   the content within the Posit Connect Dashboard window. - Note that if you specify the `content_guid` more than once like this,   `content_guid=6f300623-1e0c-48e6-a473-ddf630c0c0c3&content_guid=&e08a86af-a262-4152-8366-f2d8ec3c54f9`   you will receive results for the first GUID only; the 2nd and subsequent `content_guid`   fields are ignored. - Note that there is a practical limit of around 40 to the number of GUIDs that   may be specified due to the length of a html query string.
    #' @param min_data_version (optional) Filter by data version.  Records with a data version lower than the given value will be excluded from the set of results.  The [Content Visit Events](../admin/historical-information/#content-visit-events) section of the Posit Connect Admin Guide explains how to interpret `data_version` values. (default value: 1)
    #' @param from (optional) The timestamp that starts the time window of interest.  Any visit information that happened prior to this timestamp will not be returned.  Example value = `2018-09-15T18:00:00Z` using [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format of (`yyyy-mm-ddThh:mm:ss` followed by either `-##:##`, `.##Z` or `Z`)
    #' @param to (optional) The timestamp that ends the time window of interest.  Any visit information that happened after this timestamp will not be returned.  Example value = `2018-09-15T18:00:00Z` using [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format of (`yyyy-mm-ddThh:mm:ss` followed by either `-##:##`, `.##Z` or `Z`)
    #' @param limit (optional) The number of records to return.  The minimum supported value is 1 and maximum supported value is 500.  Note that `limit` is a \"best effort\" request since there may not be enough visit entries to satisfy the limit. (default value: 20)
    #' @param previous (optional) Retrieve the previous page of content visit logs relative to the provided value.  This value corresponds to an internal reference within the server and should be sourced from the appropriate attribute within the paging object of a previous response.
    #' @param var_next (optional) Retrieve the next page of content visit logs relative to the provided value.  This value corresponds to an internal reference within the server and should be sourced from the appropriate attribute within the paging object of a previous response.
    #' @param asc_order (optional) Determines if the response records should be listed in ascending or descending order within the response.  Ordering is by the `started` timestamp field. (default value: TRUE)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return object
    #' @export
    GetContentVisits = function(content_guid = NULL, min_data_version = 1, from = NULL, to = NULL, limit = 20, previous = NULL, var_next = NULL, asc_order = TRUE, data_file = NULL, ...) {
      local_var_response <- self$GetContentVisitsWithHttpInfo(content_guid, min_data_version, from, to, limit, previous, var_next, asc_order, data_file = data_file, ...)
    ...
    #' @export
    GetContentVisitsWithHttpInfo = function(content_guid = NULL, min_data_version = 1, from = NULL, to = NULL, limit = 20, previous = NULL, var_next = NULL, asc_order = TRUE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (`limit` > 500) {
        rlang::abort(message = "Invalid value for `limit` when calling InstrumentationApi$GetContentVisits, must be smaller than or equal to 500.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `limit` when calling InstrumentationApi$GetContentVisits, must be smaller than or equal to 500."))
      }
      if (`limit` < 1) {
        rlang::abort(message = "Invalid value for `limit` when calling InstrumentationApi$GetContentVisits, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `limit` when calling InstrumentationApi$GetContentVisits, must be bigger than or equal to 1."))
      }




      query_params[["content_guid"]] <- `content_guid`

      query_params[["min_data_version"]] <- `min_data_version`
      ...
      query_params[["next"]] <- `var_next`

      query_params[["asc_order"]] <- `asc_order`

      local_var_url_path <- "/v1/instrumentation/content/visits"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "object", loadNamespace("connectapi2")),
          error = function(e) {
    ...
    #' Get Shiny App Usage
    #'
    #' @param content_guid (optional) Filter results by content GUID.  This parameter will limit the results to include only the access records for the Shiny application(s) matching the content GUID filter value.  Example value = `6f300623-1e0c-48e6-a473-ddf630c0c0c3` using UUID [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format.  Multiple content GUIDs may be specified using the bar character `|` which represents a logical OR across the surounding GUIDs.  For example, `content_guid=6f300623-1e0c-48e6-a473-ddf630c0c0c3|e08a86af-a262-4152-8366-f2d8ec3c54f9` will filter the result set to only the access records for the Shiny Applications with a GUID of `6f300623-1e0c-48e6-a473-ddf630c0c0c3` or a GUID of `e08a86af-a262-4152-8366-f2d8ec3c54f9`.  - The GUID associated with a published Shiny application can be found on the   Info panel for the application within the Posit Connect Dashboard window. - Note that if you specify the `content_guid` more than once like this,   `content_guid=6f300623-1e0c-48e6-a473-ddf630c0c0c3&content_guid=&e08a86af-a262-4152-8366-f2d8ec3c54f9`   you will receive results for the first GUID only; the 2nd and subsequent `content_guid`   fields are ignored. - Note that there is a practical limit of around 40 to the number of GUIDs that   may be specified due to the length of a html query string.
    #' @param min_data_version (optional) Filter by data version.  Records with a data version lower than the given value will be excluded from the set of results.  The [Shiny Application Events](../admin/historical-information/#shiny-application-events) section of the Posit Connect Admin Guide explains how to interpret `data_version` values. (default value: 1)
    #' @param from (optional) The timestamp that starts the time window of interest.  Any usage information that _ends_ prior to this timestamp will not be returned.  Individual records may contain a starting time that is before this if they end after it or have not finished.  Example value = `2018-09-15T18:00:00Z` using [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format of (`yyyy-mm-ddThh:mm:ss` followed by either `-##:##`, `.##Z` or `Z`)
    #' @param to (optional) The timestamp that ends the time window of interest.  Any usage information that _starts_ after this timestamp will not be returned.  Individual records may contain an ending time that is after this (or no ending time) if they start before it.  Example value = `2018-09-15T18:00:00Z` using [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format of (`yyyy-mm-ddThh:mm:ss` followed by either `-##:##`, `.##Z` or `Z`)
    #' @param limit (optional) The number of records to return.  The minimum supported value is 1 and maximum supported value is 500.  Note that `limit` is a \"best effort\" request since there may not be enough usage entries to satisfy the limit. (default value: 20)
    #' @param previous (optional) Retrieve the previous page of Shiny application usage logs relative to the provided value.  This value corresponds to an internal reference within the server and should be sourced from the appropriate attribute within the paging object of a previous response.
    #' @param var_next (optional) Retrieve the next page of Shiny application usage logs relative to the provided value.  This value corresponds to an internal reference within the server and should be sourced from the appropriate attribute within the paging object of a previous response.
    #' @param asc_order (optional) Determines if the response records should be listed in ascending or descending order within the response.  Ordering is by the `started` timestamp field. (default value: TRUE)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return object
    #' @export
    GetShinyAppUsage = function(content_guid = NULL, min_data_version = 1, from = NULL, to = NULL, limit = 20, previous = NULL, var_next = NULL, asc_order = TRUE, data_file = NULL, ...) {
      local_var_response <- self$GetShinyAppUsageWithHttpInfo(content_guid, min_data_version, from, to, limit, previous, var_next, asc_order, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (object) with additional information such as HTTP status code, headers
    #' @export
    GetShinyAppUsageWithHttpInfo = function(content_guid = NULL, min_data_version = 1, from = NULL, to = NULL, limit = 20, previous = NULL, var_next = NULL, asc_order = TRUE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (`limit` > 500) {
        rlang::abort(message = "Invalid value for `limit` when calling InstrumentationApi$GetShinyAppUsage, must be smaller than or equal to 500.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `limit` when calling InstrumentationApi$GetShinyAppUsage, must be smaller than or equal to 500."))
      }
      if (`limit` < 1) {
        rlang::abort(message = "Invalid value for `limit` when calling InstrumentationApi$GetShinyAppUsage, must be bigger than or equal to 1.",
                     .subclass = "ApiException",
                     ApiException = ApiException$new(status = 0,
                                                     reason = "Invalid value for `limit` when calling InstrumentationApi$GetShinyAppUsage, must be bigger than or equal to 1."))
      }
      ...
      local_var_url_path <- "/v1/instrumentation/shiny/usage"
      # API key authentication
      if ("Authorization" %in% names(self$api_client$api_keys) && nchar(self$api_client$api_keys["Authorization"]) > 0) {
        header_params["Authorization"] <- paste(unlist(self$api_client$api_keys["Authorization"]), collapse = "")
      }
