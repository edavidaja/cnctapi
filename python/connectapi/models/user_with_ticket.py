...
class UserWithTicket(object):
    ...
    def __init__(self, guid=None, email=None, username=None, first_name=None, last_name=None, user_role=None, created_time=None, updated_time=None, active_time=None, confirmed=None, locked=None, temp_ticket=None):  # noqa: E501
        """UserWithTicket - a model defined in Swagger"""  # noqa: E501
        self._guid = None
        self._email = None
        self._username = None
    ...
    @property
    def guid(self):
        """Gets the guid of this UserWithTicket.  # noqa: E501

        The user's GUID, or unique identifier in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format. When a user does not exist in the Posit Connect server, this property will be `null`.  # noqa: E501

        :return: The guid of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
        return self._guid
    ...
    @guid.setter
    def guid(self, guid):
        """Sets the guid of this UserWithTicket.

        The user's GUID, or unique identifier in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format. When a user does not exist in the Posit Connect server, this property will be `null`.  # noqa: E501

        :param guid: The guid of this UserWithTicket.  # noqa: E501
        :type: str
        """
        if guid is None:
    ...
    @property
    def email(self):
        """Gets the email of this UserWithTicket.  # noqa: E501

        The user's email  # noqa: E501

        :return: The email of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this UserWithTicket.

        The user's email  # noqa: E501

        :param email: The email of this UserWithTicket.  # noqa: E501
        :type: str
        """
        if email is None:
    ...
    @property
    def username(self):
        """Gets the username of this UserWithTicket.  # noqa: E501

        The user's username  # noqa: E501

        :return: The username of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this UserWithTicket.

        The user's username  # noqa: E501

        :param username: The username of this UserWithTicket.  # noqa: E501
        :type: str
        """
        if username is None:
    ...
    @property
    def first_name(self):
        """Gets the first_name of this UserWithTicket.  # noqa: E501

        The user's first name  # noqa: E501

        :return: The first_name of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this UserWithTicket.

        The user's first name  # noqa: E501

        :param first_name: The first_name of this UserWithTicket.  # noqa: E501
        :type: str
        """
    ...
    @property
    def last_name(self):
        """Gets the last_name of this UserWithTicket.  # noqa: E501

        The user's last name  # noqa: E501

        :return: The last_name of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """Sets the last_name of this UserWithTicket.

        The user's last name  # noqa: E501

        :param last_name: The last_name of this UserWithTicket.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_role(self):
        """Gets the user_role of this UserWithTicket.  # noqa: E501

        The user's role  # noqa: E501

        :return: The user_role of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
    ...
    def user_role(self, user_role):
        """Sets the user_role of this UserWithTicket.

        The user's role  # noqa: E501

        :param user_role: The user_role of this UserWithTicket.  # noqa: E501
        :type: str
        """
        if user_role is None:
            raise ValueError("Invalid value for `user_role`, must not be `None`")  # noqa: E501
        allowed_values = ["administrator", "publisher", "viewer"]  # noqa: E501
    ...
    def created_time(self):
        """Gets the created_time of this UserWithTicket.  # noqa: E501

        The timestamp (in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format) when the user was created in the Posit Connect server  # noqa: E501

        :return: The created_time of this UserWithTicket.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this UserWithTicket.

        The timestamp (in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format) when the user was created in the Posit Connect server  # noqa: E501

        :param created_time: The created_time of this UserWithTicket.  # noqa: E501
        :type: datetime
        """
    ...
    def updated_time(self):
        """Gets the updated_time of this UserWithTicket.  # noqa: E501

        The timestamp (in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format) when the user was last updated in the Posit Connect server  # noqa: E501

        :return: The updated_time of this UserWithTicket.  # noqa: E501
        :rtype: datetime
        """
    ...
    def updated_time(self, updated_time):
        """Sets the updated_time of this UserWithTicket.

        The timestamp (in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format) when the user was last updated in the Posit Connect server  # noqa: E501

        :param updated_time: The updated_time of this UserWithTicket.  # noqa: E501
        :type: datetime
        """
    ...
    def active_time(self):
        """Gets the active_time of this UserWithTicket.  # noqa: E501

        The timestamp (in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format) when the user was last active on the Posit Connect server  # noqa: E501

        :return: The active_time of this UserWithTicket.  # noqa: E501
        :rtype: datetime
        """
    ...
    def active_time(self, active_time):
        """Sets the active_time of this UserWithTicket.

        The timestamp (in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format) when the user was last active on the Posit Connect server  # noqa: E501

        :param active_time: The active_time of this UserWithTicket.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def confirmed(self):
        """Gets the confirmed of this UserWithTicket.  # noqa: E501

        Whether or not the user is confirmed. This property will always be `true` for all authentication providers except password.  # noqa: E501

        :return: The confirmed of this UserWithTicket.  # noqa: E501
        :rtype: bool
        """
    ...
    def confirmed(self, confirmed):
        """Sets the confirmed of this UserWithTicket.

        Whether or not the user is confirmed. This property will always be `true` for all authentication providers except password.  # noqa: E501

        :param confirmed: The confirmed of this UserWithTicket.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def locked(self):
        """Gets the locked of this UserWithTicket.  # noqa: E501

        Whether or not the user is locked  # noqa: E501

        :return: The locked of this UserWithTicket.  # noqa: E501
        :rtype: bool
        """
        return self._locked
    ...
    def locked(self, locked):
        """Sets the locked of this UserWithTicket.

        Whether or not the user is locked  # noqa: E501

        :param locked: The locked of this UserWithTicket.  # noqa: E501
        :type: bool
        """
        if locked is None:
    ...
    @property
    def temp_ticket(self):
        """Gets the temp_ticket of this UserWithTicket.  # noqa: E501

        This value is for actions that require a `temp_ticket`, such as adding an LDAP or OAuth2 with Google user to the Connect server.  # noqa: E501

        :return: The temp_ticket of this UserWithTicket.  # noqa: E501
        :rtype: str
        """
        return self._temp_ticket

    @temp_ticket.setter
    def temp_ticket(self, temp_ticket):
        """Sets the temp_ticket of this UserWithTicket.

        This value is for actions that require a `temp_ticket`, such as adding an LDAP or OAuth2 with Google user to the Connect server.  # noqa: E501

        :param temp_ticket: The temp_ticket of this UserWithTicket.  # noqa: E501
        :type: str
        """
        if temp_ticket is None:
            raise ValueError("Invalid value for `temp_ticket`, must not be `None`")  # noqa: E501

        self._temp_ticket = temp_ticket
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserWithTicket, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserWithTicket):
            return False
