...
class ShinyAppUsage(object):
    ...
    def __init__(self, content_guid=None, user_guid=None, started=None, ended=None, data_version=None):  # noqa: E501
        """ShinyAppUsage - a model defined in Swagger"""  # noqa: E501
    ...
    def content_guid(self):
        """Gets the content_guid of this ShinyAppUsage.  # noqa: E501

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the Shiny application this information pertains to.  # noqa: E501

        :return: The content_guid of this ShinyAppUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def content_guid(self, content_guid):
        """Sets the content_guid of this ShinyAppUsage.

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the Shiny application this information pertains to.  # noqa: E501

        :param content_guid: The content_guid of this ShinyAppUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_guid(self):
        """Gets the user_guid of this ShinyAppUsage.  # noqa: E501

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the user that visited the application.  # noqa: E501

        :return: The user_guid of this ShinyAppUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def user_guid(self, user_guid):
        """Sets the user_guid of this ShinyAppUsage.

        The GUID, in [RFC4122](https://www.rfc-editor.org/rfc/rfc4122) format, of the user that visited the application.  # noqa: E501

        :param user_guid: The user_guid of this ShinyAppUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def started(self):
        """Gets the started of this ShinyAppUsage.  # noqa: E501

        The timestamp, in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format, when the user opened the application.  # noqa: E501

        :return: The started of this ShinyAppUsage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def started(self, started):
        """Sets the started of this ShinyAppUsage.

        The timestamp, in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format, when the user opened the application.  # noqa: E501

        :param started: The started of this ShinyAppUsage.  # noqa: E501
        :type: datetime
        """
        if started is None:
    ...
    @property
    def ended(self):
        """Gets the ended of this ShinyAppUsage.  # noqa: E501

        The timestamp, in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format, when the user left the application.  # noqa: E501

        :return: The ended of this ShinyAppUsage.  # noqa: E501
        :rtype: datetime
        """
        return self._ended
    ...
    def ended(self, ended):
        """Sets the ended of this ShinyAppUsage.

        The timestamp, in [RFC3339](https://www.rfc-editor.org/rfc/rfc3339) format, when the user left the application.  # noqa: E501

        :param ended: The ended of this ShinyAppUsage.  # noqa: E501
        :type: datetime
        """
        if ended is None:
    ...
    def data_version(self):
        """Gets the data_version of this ShinyAppUsage.  # noqa: E501

        The data version the record was recorded with.  The [Shiny Application Events](../admin/historical-information/#shiny-application-events) section of the Posit Connect Admin Guide explains how to interpret `data_version` values.  # noqa: E501

        :return: The data_version of this ShinyAppUsage.  # noqa: E501
        :rtype: int
        """
    ...
    def data_version(self, data_version):
        """Sets the data_version of this ShinyAppUsage.

        The data version the record was recorded with.  The [Shiny Application Events](../admin/historical-information/#shiny-application-events) section of the Posit Connect Admin Guide explains how to interpret `data_version` values.  # noqa: E501

        :param data_version: The data_version of this ShinyAppUsage.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShinyAppUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShinyAppUsage):
            return False
