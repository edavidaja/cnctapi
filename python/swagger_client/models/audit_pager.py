...
class AuditPager(object):
    ...
    def __init__(self, cursors=None, first=None, previous=None, next=None, last=None):  # noqa: E501
        """AuditPager - a model defined in Swagger"""  # noqa: E501
        self._cursors = None
        self._first = None
        self._previous = None
        self._next = None
    ...
    @property
    def cursors(self):
        """Gets the cursors of this AuditPager.  # noqa: E501


        :return: The cursors of this AuditPager.  # noqa: E501
        :rtype: AuditPagerCursors
        """
        return self._cursors

    @cursors.setter
    def cursors(self, cursors):
        """Sets the cursors of this AuditPager.


        :param cursors: The cursors of this AuditPager.  # noqa: E501
    ...
    @property
    def first(self):
        """Gets the first of this AuditPager.  # noqa: E501
        ...
        :return: The first of this AuditPager.  # noqa: E501
        :rtype: str
        """
        return self._first
    ...
    def first(self, first):
        """Sets the first of this AuditPager.

        A full URL of the first page of results.  It will be `null` if the current response represents the first page of results.  # noqa: E501

        :param first: The first of this AuditPager.  # noqa: E501
        :type: str
        """
        if first is None:
    ...
    @property
    def previous(self):
        """Gets the previous of this AuditPager.  # noqa: E501

        A full URL of the previous page of results when the curent request was made.  It will be `null` if the current response represents the first page of results.  # noqa: E501

        :return: The previous of this AuditPager.  # noqa: E501
        :rtype: str
        """
    ...
    def previous(self, previous):
        """Sets the previous of this AuditPager.

        A full URL of the previous page of results when the curent request was made.  It will be `null` if the current response represents the first page of results.  # noqa: E501

        :param previous: The previous of this AuditPager.  # noqa: E501
        :type: str
        """
        if previous is None:
    ...
    @property
    def next(self):
        """Gets the next of this AuditPager.  # noqa: E501

        A full URL of the next page of results when the current request was made.  It will be `null` if the current response represents the last page of results.  # noqa: E501

        :return: The next of this AuditPager.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this AuditPager.

        A full URL of the next page of results when the current request was made.  It will be `null` if the current response represents the last page of results.  # noqa: E501

        :param next: The next of this AuditPager.  # noqa: E501
        :type: str
        """
        if next is None:
    ...
    @property
    def last(self):
        """Gets the last of this AuditPager.  # noqa: E501
        ...
        :return: The last of this AuditPager.  # noqa: E501
        :rtype: str
        """
        return self._last
    ...
    @last.setter
    def last(self, last):
        """Sets the last of this AuditPager.

        A full URL of the last page of results.  It will be `null` if the current response represents the last page of results.  # noqa: E501

        :param last: The last of this AuditPager.  # noqa: E501
        :type: str
        """
        if last is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuditPager):
            return False
