...
class V1UsersBody1(object):
    ...
    def __init__(self, username=None, email=None, first_name='', last_name='', user_role=None, user_must_set_password=False, password='', unique_id=None):  # noqa: E501
        """V1UsersBody1 - a model defined in Swagger"""  # noqa: E501
        self._username = None
        self._email = None
        self._first_name = None
        self._last_name = None
        self._user_role = None
        self._user_must_set_password = None
        self._password = None
        ...
        if user_must_set_password is not None:
    ...
    @property
    def username(self):
        """Gets the username of this V1UsersBody1.  # noqa: E501

        The user's desired username  # noqa: E501

        :return: The username of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this V1UsersBody1.

        The user's desired username  # noqa: E501

        :param username: The username of this V1UsersBody1.  # noqa: E501
        :type: str
        """
        if username is None:
    ...
    @property
    def email(self):
        """Gets the email of this V1UsersBody1.  # noqa: E501

        The user's email.  # noqa: E501

        :return: The email of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this V1UsersBody1.

        The user's email.  # noqa: E501

        :param email: The email of this V1UsersBody1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def first_name(self):
        """Gets the first_name of this V1UsersBody1.  # noqa: E501

        The user's first name  # noqa: E501

        :return: The first_name of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this V1UsersBody1.

        The user's first name  # noqa: E501

        :param first_name: The first_name of this V1UsersBody1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def last_name(self):
        """Gets the last_name of this V1UsersBody1.  # noqa: E501

        The user's last name  # noqa: E501

        :return: The last_name of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """Sets the last_name of this V1UsersBody1.

        The user's last name  # noqa: E501

        :param last_name: The last_name of this V1UsersBody1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_role(self):
        """Gets the user_role of this V1UsersBody1.  # noqa: E501

        The user's role. If `null` it will default to the role specified by the config setting `Authorization.DefaultUserRole`.  # noqa: E501

        :return: The user_role of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def user_role(self, user_role):
        """Sets the user_role of this V1UsersBody1.

        The user's role. If `null` it will default to the role specified by the config setting `Authorization.DefaultUserRole`.  # noqa: E501

        :param user_role: The user_role of this V1UsersBody1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_must_set_password(self):
        """Gets the user_must_set_password of this V1UsersBody1.  # noqa: E501

        Applies only to password authentication.  - When `true`, the created user will be asked to set their password on first login. The `password` request parameter cannot be set when this parameter is `true`. - When `false`, you must specify the `password`.  # noqa: E501

        :return: The user_must_set_password of this V1UsersBody1.  # noqa: E501
        :rtype: bool
        """
        return self._user_must_set_password

    @user_must_set_password.setter
    def user_must_set_password(self, user_must_set_password):
        """Sets the user_must_set_password of this V1UsersBody1.

        Applies only to password authentication.  - When `true`, the created user will be asked to set their password on first login. The `password` request parameter cannot be set when this parameter is `true`. - When `false`, you must specify the `password`.  # noqa: E501

        :param user_must_set_password: The user_must_set_password of this V1UsersBody1.  # noqa: E501
        :type: bool
        """

        self._user_must_set_password = user_must_set_password

    @property
    def password(self):
        """Gets the password of this V1UsersBody1.  # noqa: E501

        Applies only to password authentication. Must be at least 6 characters long. Cannot be set when `user_must_set_password` is true.  # noqa: E501

        :return: The password of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this V1UsersBody1.

        Applies only to password authentication. Must be at least 6 characters long. Cannot be set when `user_must_set_password` is true.  # noqa: E501

        :param password: The password of this V1UsersBody1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def unique_id(self):
        """Gets the unique_id of this V1UsersBody1.  # noqa: E501

        Applies only to proxied authentication when `ProxyAuth.UniqueIdHeader` is being used.  It is required when SAML or OAuth2 (non-Google) authentication is being used.  # noqa: E501

        :return: The unique_id of this V1UsersBody1.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_id(self, unique_id):
        """Sets the unique_id of this V1UsersBody1.

        Applies only to proxied authentication when `ProxyAuth.UniqueIdHeader` is being used.  It is required when SAML or OAuth2 (non-Google) authentication is being used.  # noqa: E501

        :param unique_id: The unique_id of this V1UsersBody1.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1UsersBody1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1UsersBody1):
            return False
