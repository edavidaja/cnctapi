...
class InlineResponse2007(object):
    ...
    def __init__(self, id=None, output=None, finished=None, code=None, error=None, last=None, result=None):  # noqa: E501
    ...
    def id(self):
        ...
        The identifier for this task.  # noqa: E501
    ...
    @property
    def output(self):
        """Gets the output of this InlineResponse2007.  # noqa: E501

        An array containing lines of output produced by the task. The initial line of output is dictated by the `first` input parameter. The offset of the last output line is indicated by the `last` response field.  # noqa: E501

        :return: The output of this InlineResponse2007.  # noqa: E501
        :rtype: list[str]
        """
        return self._output
    ...
    def output(self, output):
        """Sets the output of this InlineResponse2007.

        An array containing lines of output produced by the task. The initial line of output is dictated by the `first` input parameter. The offset of the last output line is indicated by the `last` response field.  # noqa: E501

        :param output: The output of this InlineResponse2007.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def finished(self):
        """Gets the finished of this InlineResponse2007.  # noqa: E501

        Indicates that a task has completed.  # noqa: E501

        :return: The finished of this InlineResponse2007.  # noqa: E501
        :rtype: bool
        """
    ...
    def finished(self, finished):
        """Sets the finished of this InlineResponse2007.

        Indicates that a task has completed.  # noqa: E501

        :param finished: The finished of this InlineResponse2007.  # noqa: E501
        :type: bool
        """
    ...
    def code(self):
        ...
        Numeric indication as to the cause of an error. Non-zero when an error has occured.  # noqa: E501
    ...
    def error(self):
        ...
        Description of the error. An empty string when no error has occurred.  # noqa: E501
    ...
    @property
    def last(self):
        """Gets the last of this InlineResponse2007.  # noqa: E501

        The total number of output lines produced so far. Use as the value to `first` in the next request to only fetch output lines beyond what you have already received.  # noqa: E501

        :return: The last of this InlineResponse2007.  # noqa: E501
        :rtype: int
        """
        return self._last
    ...
    @last.setter
    def last(self, last):
        """Sets the last of this InlineResponse2007.

        The total number of output lines produced so far. Use as the value to `first` in the next request to only fetch output lines beyond what you have already received.  # noqa: E501

        :param last: The last of this InlineResponse2007.  # noqa: E501
        :type: int
        """
